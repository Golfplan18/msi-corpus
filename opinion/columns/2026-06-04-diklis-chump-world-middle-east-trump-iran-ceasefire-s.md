---
headline: I AM NEGOTIATING A TREMENDOUS DEAL, VERY FAST OR VERY SLOW, BUT ALWAYS WINNING
publish_date: '2026-06-04'
lede: The Wall Street Journal reports the U.S. and Iran engaged in intense fighting
  this week, with Iranian drones and missiles striking U.S. bases and Kuwait’s international
  airport, leaving one American dead.
...
generation_timestamp: '2026-06-05T05:34:51Z'
source_cluster_id: cluster_wsj_2026-06-04_world-middle-east-trump-iran-ceasefire-s
gdelt_event_ids: []
...
draft: false
image:
  url: /cartoons/i-am-negotiating-a-tremendous-deal-very-fast-or-very-slow.png
  alt: 'Editorial cartoon by Hector Rentier: I AM NEGOTIATING A TREMENDOUS DEAL, VERY
    FAST OR VERY SLOW, BUT ALWAYS WINNING'
  caption: He calls moderate killing a ceasefire.
  credit: Hector Rentier (Main Street Independent, algorithmic)
  source: ai_generated
  disclosure: AI-generated illustration. Prompt summary and model identifier available
    in metadata.
  ai_model: openrouter:openai/gpt-5.4-image-2
  ai_prompt: Single‑panel wood‑engraving, heavy cross‑hatch, 1:1. In the foreground,
    a stout figure in an over‑tailored suit stands at a grand podium, face fully rendered
    in an ecstatic, self‑pleased grin, arms sp
  license: https://creativecommons.org/publicdomain/zero/1.0/
paired_cartoon:
  pen_name: hector-rentier
  slug: 2026-06-04-hector-paired-with-2026-06-04-diklis-chump-world-middle-east-trump-iran-ceasefire-s
---

![Editorial cartoon by Hector Rentier: I AM NEGOTIATING A TREMENDOUS DEAL, VERY FAST OR VERY SLOW, BUT ALWAYS WINNING](/cartoons/i-am-negotiating-a-tremendous-deal-very-fast-or-very-slow.png)
*He calls moderate killing a ceasefire.*
...
The Journal says the blockade is causing massive disruptions in global energy markets—as we noted when the [President paused Iran strikes for negotiations](/articles/2026-05-18-trump-pauses-iran-strike-planned-for-tuesday-amid-serious-negotiations/)—but I love disruptions, they're the only way to really make the money. The net worth of the Hormuz deal is twelve trillion dollars, completely self-made, I have it on the highest authority. The most ships in history, the biggest blockade, and the historians are saying this move is bigger than Lincoln’s blockade, much bigger, the Lincoln historians in New York right now, they’re calling me, Sir Sir.
...
This deal is going to be tremendous, I’m going to go out, I’ll meet them at the Stratosphere, we’ll sign it on the rollercoaster, and with one stroke, I’ll end the [Hormuz ceasefire status](/articles/2026-05-10-trump-declares-iran-ceasefire-on-life-support-as-hormuz-stays-shut/) and have the tankers moving again, VERY FAST, very smart. Believe me.
