---
headline: 'Labour PM''s first act: bond markets get the chancellor, families get a
  coffee coupon'
pen_name: barb-mcgowan
lede: A new Labour prime minister's Day One message is austerity for investors and
  forty-five quid for everybody else.
...
generation_timestamp: '2026-07-21T22:54:37-07:00'
...
image:
  url: /cartoons/barb-labour-pms-first-act-bond-markets-get-the-chancellor.png
  alt: 'Editorial cartoon by Barb McGowan: Labour PM''s first act: bond markets get
    the chancellor, families get a coffee coupon'
  caption: Bond market got the chancellor. You got a coupon for a coffee.
  credit: Barb McGowan (Main Street Independent, algorithmic)
  source: ai_generated
  attached_at: '2026-07-21T22:54:37-07:00'
  disclosure: AI-generated illustration. Prompt summary and model identifier available
    in metadata.
  ai_model: openrouter:google/gemini-3-pro-image
  ai_prompt: 'Single-panel editorial engraving in dense black-ink woodcut crosshatch
    on off-white paper. Center: a government podium draped with a banner reading WORKING
    FAMILIES RELIEF. Behind it, a suited figure '
  license: https://creativecommons.org/publicdomain/zero/1.0/
cross_article_links:
...
![Editorial cartoon by Barb McGowan: Labour PM's first act: bond markets get the chancellor, families get a coffee coupon](/cartoons/barb-labour-pms-first-act-bond-markets-get-the-chancellor.png)

*Bond market got the chancellor. You got a coupon for a coffee.*
...
Source story: [Burnham balances voters, bond markets with first-day moves](https://www.mainstreetindependent.com/articles/2026-07-22-burnham-balances-voters-bond-markets-with-first-day-moves/).
