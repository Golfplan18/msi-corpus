...
generation_timestamp: '2026-08-06T05:04:35-07:00'
source_cluster_id: cluster_guardian_2026-08-04_commentisfree-2026-aug-04-kalshi-predict
gdelt_event_ids: []
...
Kalshi is not yet offering bets on treatments for children. The company says it will not allow them. That limitation does not answer the larger problem, because the architecture is the point. Kalshi’s [first proposed contracts include a wager on whether an anti-cancer drug will gain FDA approval](https://www.theguardian.com/technology/2026/jul/16/kalshi-betting-drug-trial-results) and another on whether an Alzheimer’s trial will meet its goals—real trials, real patients, real families praying for good news. Mansour has imagined a world in which “any difference in opinion” is wagerable.

Children’s treatments are not on the menu—yet. The company has not ruled out the principle that would put them there. The regulatory environment will not necessarily stop it. The [Trump administration is going to remarkable lengths to shield prediction markets from state regulation](https://www.msn.com/en-us/money/financial-regulation/trump-regulator-orders-kalshi-to-defy-michigan-court-escalating-battle-over-prediction-markets/ar-AA288ebZ). The same platform [Meta’s Mark Zuckerberg has been courting for acquisition](/articles/2026-06-30-zuckerberg-meets-with-kalshi-ceo-about-acquisition-sources-say/) has [already expanded from elections to flight cancellations](/articles/2026-07-15-kalshi-files-to-offer-flight-cancellation-prediction-contracts/). A cancelled flight is an inconvenience. A failed cancer trial is not.
...
**Title:** My son has cancer. Kalshi wants you to be able to bet on his medical future | Joshua Pederson
**URL:** https://www.theguardian.com/commentisfree/2026/aug/04/kalshi-predictions-market-clinical-trial
