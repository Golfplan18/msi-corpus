...
generation_timestamp: '2026-07-18T00:44:10-07:00'
...
That text was cited by the three-judge panel that first blocked Alabama's map. The panel found the state had diluted Black voting power in violation of the Voting Rights Act and ordered a second majority-Black district drawn. Alabama defied the order. The case returned to the Supreme Court. In April, the [Supreme Court allowed Alabama to use the map eliminating the majority-Black district](/articles/2026-06-03-supreme-court-allows-alabama-to-use-map-eliminating-majority-black-district/) — [the same decision that eliminated the state's second Democratic seat](/articles/2026-07-11-supreme-court-reinstatement-of-alabama-map-eliminates-second-democratic-district/).
...
The AG's comparison does not hold. California uses an independent redistricting commission. Alabama's legislature drew its own map, and the record contains its own members calling the state capital — a majority-Black city — "monkey town." The three-judge panel that first blocked the map cited that text as evidence. The mechanism of suppression is not speculative. The [rally in Montgomery this past May](/articles/2026-05-17-thousands-rally-in-montgomery-to-defend-black-voting-power-after-scotus/) was organized by people who read the same record.
