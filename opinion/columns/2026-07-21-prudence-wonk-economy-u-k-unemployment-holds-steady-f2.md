...
generation_timestamp: '2026-07-21T02:08:05-07:00'
...
The employment-tax argument is real as a labor-supply depressant — the employer National Insurance increase combined with frozen personal-allowance thresholds raises the cost of hiring without raising the value of working. But that is a fiscal-policy choice, not a monetary-policy variable the Bank should be waiting to clear. The Bank has [spent months](/articles/2026-06-15-bank-of-england-expected-to-hold-key-rate-at-3-75-as-u-k-economy-weakens/) signaling it would respond if the conflict began feeding through into persistent inflation. The data keep arriving and the feeding-through keeps not happening.
