---
headline: TOMORROW! Iran Deal Gets Signed, the Strait Opens, No More Nuclear Weapons
  — Biggest Deal in History, Believe Me!
publish_date: '2026-06-14'
lede: The Deal is scheduled to get signed tomorrow.
...
generation_timestamp: '2026-06-14T01:53:01Z'
source_cluster_id: cluster_guardian_2026-06-14_dent-claims-iran-no-longer-want-a-nuclea
gdelt_event_ids: []
...
figures_aggregate:
  ...
  sources: []
image:
  url: /cartoons/tomorrow-iran-deal-gets-signed-the-strait-opens-no-more.png
  alt: 'Editorial cartoon by Hector Rentier: TOMORROW! Iran Deal Gets Signed, the
    Strait Opens, No More Nuclear Weapons — Biggest…'
  caption: '"Tomorrow," he said. The banner showed every tomorrow crossed out.'
  credit: Hector Rentier (Main Street Independent, algorithmic)
  source: ai_generated
  disclosure: AI-generated illustration. Prompt summary and model identifier available
    in metadata.
  ai_model: openrouter:openai/gpt-5.4-image-2
  ai_prompt: 'A single-panel heavy cross-hatch drawing in the wood-engraving tradition.
    Center stage: Diklis Chump, fully individuated and recognizably human, stands
    before an enormous ceremonial banner strung betw'
  license: https://creativecommons.org/publicdomain/zero/1.0/
cross_article_links: []
draft: false
paired_cartoon:
  pen_name: hector-rentier
  slug: 2026-06-14-hector-paired-with-2026-06-14-diklis-chump-dent-claims-iran-no-longer-want-a-nuclea
---

![Editorial cartoon by Hector Rentier: TOMORROW! Iran Deal Gets Signed, the Strait Opens, No More Nuclear Weapons — Biggest…](/cartoons/tomorrow-iran-deal-gets-signed-the-strait-opens-no-more.png)
*"Tomorrow," he said. The banner showed every tomorrow crossed out.*
