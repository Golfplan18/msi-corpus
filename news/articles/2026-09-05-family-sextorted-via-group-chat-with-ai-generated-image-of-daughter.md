...
secondary_headline: Cybersecurity firms say open-weight AI models automate targeting
  of relatives
publish_date: '2026-09-05'
lede: Late last month, a scammer used a group text message to send what appeared to
  be an AI-generated sexual image of a Missouri family's 24-year-old daughter to multiple
  relatives across two households, including in-laws and a 16-year-old brother, The
  Wall Street Journal reported. Cybersecurity experts told the Journal that AI now
  automates the assembly of contact networks that include extended family — pulling
  emails, phone numbers, and hints about how people are related from compromised accounts
  and public profiles. According to the Journal, scammers are finding new targets,
  and AI is making it easier.
nut_graf: Identity theft monitoring firm IdentityIQ and cybersecurity firm McAfee
  both said consumers face a lower technical barrier as open-weight AI models — publicly
  released artificial-intelligence systems free to download — become widely available
  to attackers running them on dedicated machines.
primary_entities:
- Cline family
- Parmley family
- IdentityIQ
...
generation_timestamp: '2026-09-05T07:19:04-07:00'
source_cluster_id: cluster_wsj_2026-09-05_tech-personal-tech-sextortion-scams-fami
gdelt_event_ids: []
...
- A scammer used a group text to send what appeared to be an AI-generated sexual image of a Missouri family's 24-year-old daughter to relatives including her mother, her husband, her in-laws, and her 16-year-old brother, The Wall Street Journal reported.
- Chris Cline, a public-relations professional for the Missouri Farm Bureau who had helped a client pitch sextortion stories, received the first group message while attending a Farm Bureau conference in New Orleans.
- IdentityIQ's Michael Scheumack said the operation is "all automated," using AI to scrape social-media accounts and publicly available images to identify how targets are related.
- McAfee's Steve Grobman said attackers are likely using open-weight AI models on dedicated machines rather than consumer services such as Gemini, ChatGPT, or Claude, which could detect and stop such abuse.
- Cybersecurity experts advised targets not to pay, but to block the sender, report the phone number or username to the FBI's Internet Crime Complaint Center, switch social-media accounts to private, and enable two-factor authentication.
