...
secondary_headline: National Democrats see contest as test of party's direction
publish_date: '2026-07-08'
lede: Michigan voters in key battlegrounds including Lansing, Macomb County, Dearborn
  and Grand Rapids are not closely following the Democratic primary for U.S. Senate,
  according to The Guardian, even as the race is one of the most closely watched in
  the November midterm elections.
nut_graf: The Aug. 4 primary between progressive Abdul El-Sayed and moderate Rep.
  Haley Stevens will determine the Democratic nominee for the seat being vacated by
  retiring Sen. Gary Peters, in a contest that national Democrats view as a test of
...
generation_timestamp: '2026-07-08T10:30:00-07:00'
source_cluster_id: cluster_guardian_2026-07-08_us-news-2026-jul-08-michigan-senate-race
gdelt_event_ids: []
...
draft: false
image:
  url: /articles/2026-07-08-michigan-voters-tuned-out-of-senate-primary-as-race-narrows-to-two.png
  alt: 'Illustration accompanying article: Michigan voters tuned out of Senate primary
    as race narrows to two'
...
- slug: 2026-06-15-alabama-voters-head-to-polls-tuesday-for-senate-primary-runoff
  ...
  strength: 0.653
---
## Michigan voters tuned out of Senate primary as race narrows to two

**Subtype:** fact

- Michigan voters in key battlegrounds including Lansing, Macomb County, Dearborn and Grand Rapids are not closely following the Democratic Senate primary, according to The Guardian.
- The race between progressive Abdul El-Sayed and moderate Rep. Haley Stevens presents one of the clearest ideological contrasts of any Democratic primary this year, according to The New York Times.
- Washington Democrats view El-Sayed as a candidate who could win the primary but lose the general election, costing the party a shot at the Senate majority, according to CNN.
- State Sen. Mallory McMorrow suspended her campaign on July 5, narrowing the field to a two-way contest ahead of the Aug. 4 primary, MSI previously reported.
...
**Title:** Washington sees this Senate race as a key test for Democrats. Michigan voters just want to get by
**URL:** https://www.theguardian.com/us-news/2026/jul/08/michigan-senate-race-democrats
