---
headline: Luxury rideshare Wheely appeals New York trip data reporting rule
secondary_headline: Fourth Amendment challenge draws support from Cato, Legal Aid,
  Chamber
publish_date: '2026-07-21'
lede: Wheely USA, a luxury rideshare company that markets discretion to wealthy and
  celebrity clients, is appealing a New York City requirement that for-hire vehicles
  submit detailed trip location data to the Taxi and Limousine Commission. The company
  argues the rule violates Fourth Amendment protections against warrantless government
  surveillance of riders' movements.
nut_graf: The case tests the boundary between municipal safety regulation and constitutional
  location-privacy protections, as the city defends rules that require operators to
  report every trip's pickup and drop-off times and locations.
primary_entities:
- Wheely USA
...
generation_timestamp: '2026-07-21T08:07:21-07:00'
source_cluster_id: cluster_wsj_2026-07-21_mpany-wants-to-stop-new-york-from-tracki
gdelt_event_ids: []
...
figures_aggregate:
  ...
  sources: []
cross_article_links:
- slug: 2026-06-29-supreme-court-rules-geofence-warrants-violate-fourth-amendment
  relation: related
  strength: 0.6002
  confidence: medium
...
- Wheely USA is appealing a New York City rule requiring for-hire vehicles to submit detailed trip location data to the Taxi and Limousine Commission, arguing it violates Fourth Amendment protections.
- A federal judge ruled this spring that the city's safety concerns outweighed any privacy intrusion, writing that Wheely was aware of the reporting requirements when it entered the market.
- The Cato Institute, the Legal Aid Society, and the U.S. Chamber of Commerce have filed legal briefs supporting Wheely's challenge.
- Wheely founder Anton Chirkunov said riders "have the right to travel in their city without their movements being tracked by the government."
