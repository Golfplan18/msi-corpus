...
secondary_headline: Inflation offers early economic boost for new PM Burnham
publish_date: '2026-07-22'
lede: LONDON — U.K. inflation fell to 2.6% in June, its lowest level since March 2025,
  as lower gasoline costs driven by the cooling of hostilities in the Middle East
  gave an early economic boost to new Prime Minister Andy Burnham days after he took
  office, the Office for National Statistics reported Wednesday. The reading came
  in below the 2.7% economists had forecast and marked the first decline since March.
nut_graf: The June inflation reading provides an early political and economic tailwind
  for the new government under Prime Minister Andy Burnham, even as analysts warn
  the relief from falling energy prices is likely temporary and will be tested by
  rising oil prices and higher regulated energy costs in the second half of the year.
primary_entities:
- Andy Burnham
...
generation_timestamp: '2026-07-22T00:24:29-07:00'
source_cluster_id: cluster_wsj_2026-07-22_world-uk-u-k-inflation-falls-to-15-month
gdelt_event_ids: []
...
- slug: 2026-07-06-canada-business-inflation-expectations-surged-during-iran-conflict-boc-survey-sh
  ...
  strength: 0.6563
image:
  url: /articles/2026-07-22-uk-inflation-falls-to-2-6-in-june-lowest-since-march-2025.png
  alt: "Illustration accompanying article: UK inflation falls to 2.6% in June, lowest since March 2025"
...
- U.K. annual inflation fell to 2.6% in June, down from 2.8% in April and May, the Office for National Statistics reported Wednesday, marking the lowest rate since March 2025 and slightly below the 2.7% economists had forecast.
- Falling gasoline costs drove the decline after the U.S.-Iran peace deal pushed global oil prices lower, with motor fuel 3.1% cheaper in June than in May.
- Inflation is expected to rise again over the summer after regulator Ofgem lifted the energy price cap for households by 13% at the start of July, and after President Trump said the tentative ceasefire with Iran was "over" and airstrikes resumed, pushing Brent crude above $92 a barrel.
- The Bank of England is widely expected to hold its key rate at 3.75% when policymakers meet next week, with Morgan Stanley chief U.K. economist Bruna Skarica saying it is hard to see a meaningful hawkish pivot "barring a sustained rise in oil prices to close to $100 a barrel."
...
MSI previously reported that [UK pump prices had fallen as Brent crude returned to pre-Iran war levels](https://www.mainstreetindependent.com/articles/2026-06-26-uk-pump-prices-fall-as-brent-crude-returns-to-pre-iran-war-levels).
