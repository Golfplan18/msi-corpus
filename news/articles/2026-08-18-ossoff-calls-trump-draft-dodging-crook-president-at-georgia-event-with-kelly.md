...
headline: Ossoff calls Trump 'draft-dodging, crook president' at Georgia event with
  Kelly
secondary_headline: Remarks defended Sen. Mark Kelly after Trump called for arrests
publish_date: '2026-08-18'
lede: Democratic Sen. Jon Ossoff of Georgia called President Donald Trump a 'draft-dodging,
  crook president' during a Tuesday campaign appearance alongside Sen. Mark Kelly,
  intensifying the pair's public feud with the White House. The remarks came roughly
  a year after Trump called for the arrests of Kelly and five other Democratic lawmakers
  over a social-media video stating troops are not required to carry out illegal commands,
  accusing them of 'SEDITIOUS BEHAVIOR, punishable by DEATH!'
nut_graf: The escalating rhetoric comes as Ossoff runs for re-election to his Georgia
  Senate seat and is widely speculated to be considering a 2028 presidential bid.
primary_entities:
- Jon Ossoff
- Donald Trump
- Mark Kelly
...
generation_timestamp: '2026-08-18T17:05:09-07:00'
source_cluster_id: cluster_guardian_2026-08-18_us-news-2026-aug-18-jon-ossoff-trump
gdelt_event_ids: []
...
related_stories:
- slug: 2026-08-17-ossoff-tells-atlanta-rally-trump-is-profiting-from-the-iran-war
  headline: Ossoff tells Atlanta rally Trump is profiting from the Iran war
...
- slug: 2026-02-20-trump-visits-georgia-as-republicans-seek-midterm-boost-amid-election-claims
  ...
  strength: 0.6728
---
## Ossoff calls Trump 'draft-dodging, crook president' at Georgia event with Kelly

**Subtype:** fact

- Sen. Jon Ossoff called President Donald Trump a "draft-dodging, crook president" at a Tuesday campaign appearance in Georgia alongside Sen. Mark Kelly.
- The remarks defended Kelly, a former Navy captain, roughly a year after Trump called for the arrests of Kelly and five other Democratic lawmakers who posted a video about illegal orders.
- Trump had accused the lawmakers of "SEDITIOUS BEHAVIOR, punishable by DEATH!" after the video appeared.
- On Sunday at an Atlanta rally, Ossoff criticized Trump's handling of the US-Israel war on Iran, saying the president "sleeps through his meetings" and "golfs and trades stocks."
- The White House responded Monday by calling Ossoff "Pee-wee Herman" and labeling him "a radical, extremist Dumocrat."
...
**Title:** Jon Ossoff condemns Trump as ‘draft-dodging, crook president’
