...
secondary_headline: AI's debt demand now competes with governments in bond markets
publish_date: '2026-08-19'
lede: The Wall Street Journal reports a global bond selloff is raising borrowing costs
  for governments, businesses and families, with little relief in sight. The newspaper
  ties the selloff to the continuing U.S.-Iran war, inflation, and an artificial-intelligence
  industry whose "enormous appetite for debt" it says now competes with traditional
  nation-state borrowers.
nut_graf: The selloff matters because The Wall Street Journal reports it is raising
  borrowing costs for governments, businesses, and households all at once, while the
  drivers behind it show little near-term relief. The same reporting says some investors
  are bracing for "a new era in bonds" and drawing comparisons to the period before
  2007.
primary_entities:
...
generation_timestamp: '2026-08-19T04:12:36-07:00'
source_cluster_id: cluster_wsj_2026-08-19_ll-street-thinks-the-brutal-bond-rout-is
gdelt_event_ids: []
...
- slug: 2026-08-17-bond-yields-rise-to-multi-year-or-multi-decade-highs-across-major-economies
  ...
  relation: related
  strength: 0.6708
- slug: 2026-08-04-world-bank-says-developing-economies-face-lower-ai-job-exposure
...
- The Wall Street Journal reports a global bond selloff is raising borrowing costs for governments, businesses and families, with little relief in sight.
- The WSJ says the continuing U.S.-Iran war and inflation are part of the story, and that artificial intelligence's "enormous appetite for debt" now puts the industry in competition with traditional nation-state borrowers.
- The WSJ reports investors are bracing for "a new era in bonds," with some drawing direct parallels — "echoes of 2007."
- The same edition reports Big Tech is confronting "a growing backlash that threatens the foundations of the AI boom."
...
**Title:** Why Wall Street Thinks the Brutal Bond Rout Is Just Getting Started
**URL:** https://www.wsj.com/world/why-wall-street-thinks-the-brutal-bond-rout-is-just-getting-started-c84e9131
