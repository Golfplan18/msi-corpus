---
headline: Botulism bacteria found in milk powder linked to ByHeart formula outbreak
publish_date: '2026-01-28'
lede: Organic whole milk powder linked to the ByHeart baby formula outbreak—which has sickened 51 infants in 19 states—tested positive for the bacteria that causes botulism, according to the Associated Press. The contaminated powder was supplied by Organic West Milk Inc., a California company, and processed at a Dairy Farmers of America facility in Fallon, Nevada, though officials said the source of the contamination remains unknown.
nut_graf: The discovery marks the first large outbreak of botulism linked to infant formula in the United States, raising questions about safety testing and oversight of formula ingredients as the investigation continues.
primary_entities:
- ByHeart
...
*Generated by Main Street Independent News Article Generator. License: [CC0 Public Domain](https://creativecommons.org/publicdomain/zero/1.0/)*
