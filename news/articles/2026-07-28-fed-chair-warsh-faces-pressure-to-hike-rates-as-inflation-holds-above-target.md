...
secondary_headline: Renewed Iran war, AI investment, and tariffs add to price pressures
publish_date: '2026-07-28'
lede: The Federal Reserve is expected to keep its key interest rate unchanged at its
  meeting this week, but Chair Kevin Warsh is under growing pressure from within the
  central bank to raise rates soon as inflation remains persistently above the Fed's
  2% target. Core inflation has risen since December and has been stuck at around
  3% or higher since 2023, with some Fed officials publicly signaling that rate hikes
  may be needed absent progress.
nut_graf: The pressure on Warsh comes as multiple forces — a renewed Iran war pushing
  up oil and gas prices, surging investment in artificial intelligence infrastructure,
  and newly imposed tariffs on dozens of U.S. trading partners — threaten to keep
  inflation elevated, adding to inflationary pressures that complicate the Fed's policy
  decisions without provoking opposition from President Donald Trump, who appointed
  Warsh.
primary_entities:
- Federal Reserve
- Kevin Warsh
...
generation_timestamp: '2026-07-28T08:02:54-07:00'
source_cluster_id: cluster_ap_2026-07-27_federal-reserve-inflation-warsh-trump-ra
gdelt_event_ids: []
...
- source: fred
  ...
  transformation: raw
  as_of: 2026-07-28
  caption: The Federal Reserve's balance sheet, measured in millions of dollars, provides
    a measure of the central bank's monetary policy posture of quantitative tightening.
figures_aggregate:
  count: 1
  series_ids:
  - WALCL
...
- slug: 2026-05-02-trump-pick-kevin-warsh-faces-a-fed-reshaped-by-powell-s-stay
  ...
  strength: 0.7566
  confidence: medium
- slug: 2026-03-18-iran-war-likely-delays-federal-reserve-interest-rate-cuts-further
  relation: related
  strength: 0.7943
  confidence: medium
...
- slug: 2026-07-15-warsh-does-not-confirm-trump-communication-in-senate-testimony
  ...
  strength: 0.8133
- slug: 2026-07-14-warsh-says-fed-has-no-tolerance-for-high-inflation-offers-no-rate-path
  headline: Warsh says Fed has 'no tolerance' for high inflation, offers no rate path
  publish_date: '2026-07-14'
  relation: related
  strength: 0.779
- slug: 2026-07-08-warsh-era-fed-minutes-reveal-stark-division-on-rate-path
  headline: Warsh-era Fed minutes reveal stark division on rate path
...
- slug: 2026-05-14-senate-confirms-kevin-warsh-as-federal-reserve-chair-replacing-powell
  ...
  strength: 0.7845
image:
  url: /articles/2026-07-28-fed-chair-warsh-faces-pressure-to-hike-rates-as-inflation-holds-above-target.png
  alt: "Illustration accompanying article: Fed Chair Warsh faces pressure to hike rates as inflation holds above target"
...
---
## Fed Chair Warsh faces pressure to hike rates as inflation holds above target

**Subtype:** fact

- The Federal Reserve is expected to hold its key interest rate steady when it meets July 28-29, but some Fed officials have said rate hikes will be needed if inflation does not show sustained progress toward the 2% target.
- Core inflation, which excludes volatile energy and food categories, has risen since December and has been stuck at around 3% or higher since 2023.
- Renewed conflict in Iran is pushing oil and gas prices higher, and surging AI infrastructure investment is raising costs for laptops, smartphones, and electricity, adding price pressures.
- Lorie Logan, president of the Federal Reserve Bank of Dallas and a voting member of the rate-setting committee, said recently that "modestly higher interest rates would better balance the outlook."
...
**Title:** Fed Chair Warsh faces pressure to combat inflation
**URL:** https://apnews.com/article/federal-reserve-inflation-warsh-trump-rate-hike-6a7e8b53a187b1193a0ee7b58df680c2
