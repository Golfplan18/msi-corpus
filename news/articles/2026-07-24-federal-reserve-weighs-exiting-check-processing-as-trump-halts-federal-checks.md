---
headline: Federal Reserve weighs exiting check processing as Trump halts federal checks
secondary_headline: Check usage per American falls to 27 a year, down from 150 in
  2000
publish_date: '2026-07-24'
lede: The Federal Reserve is considering whether to wind down its check processing
  operations, a move that would follow President Donald Trump’s executive order halting
  federal check writing and come as check usage falls to historic lows.
nut_graf: While the U.S. still writes billions of checks annually, the decline has
  been steep, and the Fed’s unit, which costs about $100 million a year to run, faces
  replacement costs for aging equipment.
primary_entities:
- Federal Reserve
- Donald Trump
- United States
...
generation_timestamp: '2026-07-24T08:06:36-07:00'
source_cluster_id: cluster_upi_2026-07-24_26-07-24-should-paper-checks-be-abolishe
gdelt_event_ids: []
...
- slug: 2026-06-24-usps-cash-crisis-delayed-until-2031-postmaster-general-tells-congress
  relation: related
  confidence: medium
- slug: 2026-06-24-all-32-biggest-u-s-banks-pass-federal-reserve-s-2026-stress-test
  relation: related
  confidence: medium
...
- President Donald Trump issued an executive order stopping federal check writing, a move that coincides with the Federal Reserve’s consideration of exiting the check processing business.
- Americans wrote 9.2 billion checks in 2024, with a total face value of more than $24 trillion, according to Federal Reserve data.
- Check usage has fallen from 150 per person in 2000 to 27 per person in 2024, while the average check amount more than doubled to $2,600.
- Small businesses remain heavy check users, with over 80 percent of businesses with sales between $1 million and $10 million making check payments, often to avoid credit card fees.
