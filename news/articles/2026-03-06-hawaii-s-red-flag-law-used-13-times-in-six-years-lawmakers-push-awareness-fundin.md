---
headline: Hawaii's red flag law used 13 times in six years; lawmakers push awareness funding
publish_date: '2026-03-06'
lede: Hawaii's gun violence protective order law has been used only 13 times since taking effect in 2020, even as more than 430 people were killed by firearms in the state between 2018 and 2024, according to data from the Centers for Disease Control and Prevention. The Honolulu Police Department has never filed a red flag petition, and a state House bill would direct roughly $500,000 over two years to public awareness campaigns and court-processing support for the orders.
nut_graf: 'Hawaii lawmakers are confronting a persistent gap between a legal tool''s existence and its use: suicides account for the majority of firearm deaths in the state, and gun violence prevention experts say the protective order''s potential role in preventing those deaths remains largely unrealized because too few residents — and too few police officers — know it exists or how to use it.'
primary_entities:
- Hawaii Legislature
