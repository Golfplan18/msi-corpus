...
lede: The Republican-led Senate voted 47 to 52 on Wednesday to reject a Democratic resolution requiring U.S. forces to withdraw from the Iran war unless Congress authorizes further action — the fourth time this year the chamber has declined to halt the conflict. The vote came as lawmakers from both parties acknowledged a statutory deadline arriving at the end of April.
nut_graf: Under the War Powers Act of 1973, Congress must declare war or authorize use of force within 60 days of a conflict's start, a deadline that arrives at the end of this month. Several Republican senators said they expect a formal authorization vote if the war continues past that point, and warned that an eventual White House war funding request — which could total hundreds of billions of dollars — will represent the next major leverage point for Congress.
primary_entities:
