...
secondary_headline: YFQ-44A Fury launches AIM-120 at simulated target over Mojave
publish_date: '2026-07-15'
lede: The U.S. Air Force's vision of autonomous fighter drones that can shoot down
  enemy planes moved from concept to demonstration this week when an Anduril-built
  jet drone fired an air-to-air missile at a simulated target over the Mojave Desert.
nut_graf: The test, conducted from Edwards Air Force Base and announced July 15, was
  the first live-weapon firing by a U.S. Collaborative Combat Aircraft drone, according
  to the Air Force. The service plans to field about 1,000 such drones that fly ahead
  of manned fighters and engage enemy aircraft, while a human operator retains the
  authority to authorize weapons release.
primary_entities:
...
generation_timestamp: '2026-07-15T16:24:49-07:00'
source_cluster_id: cluster_wsj_2026-07-15_s-long-range-missile-from-combat-jet-dro
gdelt_event_ids: []
...
draft: false
image:
  url: /articles/2026-07-15-anduril-drone-fires-live-missile-in-first-air-force-combat-drone-test.png
  alt: 'Illustration accompanying article: Anduril drone fires live missile in first
    Air Force combat-drone test'
...
**Title:** Air Force Test Fires Long-Range Missile From Combat Jet Drone for the First Time
**URL:** https://www.wsj.com/politics/national-security/air-force-test-fires-long-range-missile-from-combat-jet-drone-for-the-first-time-adc3c092
