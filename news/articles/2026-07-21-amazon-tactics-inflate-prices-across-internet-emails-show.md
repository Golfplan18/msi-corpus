...
secondary_headline: California AG says Amazon used code words to avoid paper trail
publish_date: '2026-07-21'
lede: Internal Amazon emails and court records reveal that the company pressured suppliers
  to raise prices on competing retail websites, according to a Guardian investigation
  and California antitrust lawsuit. The tactics included product suppression and compensation
  demands that allegedly drove up prices for consumers at retailers including Walmart,
  Target and Home Depot.
nut_graf: The investigation details Amazon's practices that allegedly led to higher
  prices on competing websites, according to internal documents and court filings.
primary_entities:
- Amazon
...
generation_timestamp: '2026-07-21T14:30:00-07:00'
source_cluster_id: cluster_guardian_2026-07-21_us-news-ng-interactive-2026-jul-21-amazo
gdelt_event_ids: []
...
- Amazon pressured suppliers to raise prices on competing retail websites using product suppression and compensation demands, according to internal emails reviewed by the Guardian and California court filings.
- California Attorney General Rob Bonta alleges the practices constitute illegal price-fixing; Amazon denies the claims, calling them a distortion of a handful of emails.
- The Guardian investigation, based on thousands of internal documents and interviews with 15 current and former employees, details tactics including coded language to avoid creating a paper trail.
- Price-fixing lawsuits by the California attorney general and the Federal Trade Commission are both scheduled for trial in early 2027.
