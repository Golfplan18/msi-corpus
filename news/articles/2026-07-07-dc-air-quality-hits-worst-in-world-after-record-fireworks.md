---
headline: DC air quality hits worst in world after record fireworks
secondary_headline: Particulate levels 6.7 times pre-fireworks baseline
publish_date: '2026-07-07'
lede: Hourly concentrations of particulate matter in Washington, D.C., rose to 6.7
  times their pre-fireworks levels after a 40-minute July 4 display that involved
  more than 850,000 shells, according to a new analysis. The city briefly recorded
  the worst air quality of any major city in the world, and officials declared a Code
  Red alert.
nut_graf: City officials declared a Code Red air quality alert after the largest fireworks
  display in D.C. history, organized by the Trump-backed nonprofit Freedom 250, sent
  hourly particulate concentrations to 6.7 times pre-fireworks levels as the region
  was also baking under an extreme heatwave.
primary_entities:
- Washington, D.C.
- Freedom 250
- Clarity Movement
...
generation_timestamp: '2026-07-07T08:18:39-07:00'
source_cluster_id: cluster_guardian_2026-07-07_us-news-2026-jul-07-washington-air-quali
gdelt_event_ids: []
...
related_stories:
- slug: 2026-06-30-dc-s-july-4-fireworks-to-be-largest-ever-starting-later-than-usual
  headline: DC's July 4 fireworks to be largest ever, starting later than usual
  publish_date: '2026-06-30'
  relation: related
  strength: 0.6922
---
## DC air quality hits worst in world after record fireworks

**Subtype:** fact

- Hourly concentrations of particulate matter in Washington, D.C., rose to 6.7 times pre-fireworks levels after the July 4 display, according to an analysis from air-quality firm Clarity Movement.
- Every one of the company's 26 sensors in the city reached levels the EPA deems "unhealthy for sensitive groups" during the event, with some recording worse emissions.
- The 40-minute show, organized by the Trump-backed nonprofit Freedom 250, involved more than 850,000 fireworks — roughly 50 times the typical D.C. display of 17,000 shells.
- City officials issued a Code Red alert, warning that outdoor air was unhealthy for seniors, children and people with medical conditions.
...
**Title:** Washington records world’s worst air quality for a city after over 850,000 Fourth of July fireworks
