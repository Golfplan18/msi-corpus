---
headline: BrewDog founder James Watt faces UK data privacy complaints
secondary_headline: ICO considers complaints over how Watt contacted former crowdfunding
  investors
publish_date: '2026-07-17'
lede: James Watt, the founder of BrewDog, is facing complaints to the UK's data privacy
  watchdog over how he obtained the contact details of thousands of former crowdfunding
  investors to invite them to join his bid to buy back the company.
nut_graf: The complaints to the Information Commissioner's Office raise questions
  about whether Watt's email campaign to former "equity punk" shareholders violated
  the General Data Protection Regulation, as neither the company that acquired BrewDog's
  assets nor the administrator handling the remainder provided the data, according
  to the Guardian.
primary_entities:
- James Watt
- BrewDog
...
generation_timestamp: '2026-07-17T00:03:24-07:00'
source_cluster_id: cluster_guardian_2026-07-17_r-james-watt-faces-data-privacy-complain
gdelt_event_ids: []
...
- slug: Schwab
  relation: related
  confidence: medium
- slug: Senate Democrats
  relation: related
  confidence: medium
draft: false
related_stories: []
---
## BrewDog founder James Watt faces UK data privacy complaints

- James Watt, the founder of BrewDog, is the subject of complaints to the UK Information Commissioner's Office over how he obtained the contact details of thousands of former crowdfunding investors to invite them to join his bid to buy back the brewery.
- The ICO has been asked to investigate by several former "equity punk" shareholders who received unsolicited emails from Watt offering them a stake in his new venture, Second Best.
- Watt denied any wrongdoing, stating the communication was sent following legal advice using lawfully obtained data in connection with shareholders' legitimate interests.
- Neither Tilray, which acquired BrewDog's brand and assets in March, nor the administrator AlixPartners provided the shareholder data, according to a Tilray spokesperson and reporting from the Guardian.
...
**Title:** ‘How’s this joker got my details?’: BrewDog founder faces complaints over emails to ‘equity punks’
