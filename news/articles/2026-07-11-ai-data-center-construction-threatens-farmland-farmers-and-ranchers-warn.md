...
secondary_headline: Roughly 5,000 data centers built or under construction nationwide
publish_date: '2026-07-11'
lede: Farmers and ranchers across the United States are sounding alarms as a boom
  in AI data center construction consumes farmland, water and electricity essential
  for agriculture. The American Farm Bureau Federation estimates there are roughly
  5,000 finished or under-construction data centers nationwide, with many sited on
  rural land.
nut_graf: The tension between technology's hunger for land and rural America's traditional
  resource base is reshaping the farm economy, with two dozen states considering restrictions
  on data center development as agricultural groups warn of permanent losses to productive
...
generation_timestamp: '2026-07-11T11:04:47-07:00'
source_cluster_id: cluster_wsj_2026-07-11_ess-energy-oil-a-new-foe-has-emerged-for
gdelt_event_ids: []
...
- slug: 2026-06-23-nearly-80-of-datacenters-vulnerable-to-climate-hazards-study-finds
  headline: Nearly 80% of datacenters vulnerable to climate hazards, study finds
...
- slug: 2026-06-10-seattle-enacts-year-long-ban-on-new-ai-datacenters
  ...
  strength: 0.6742
---
## AI data center construction threatens farmland, farmers and ranchers warn

**Subtype:** fact

- Farmers and ranchers warn that AI data center construction is competing for farmland, electricity and water needed for crop and livestock production.
- The American Farm Bureau Federation estimates roughly 5,000 data centers are finished or under construction across the U.S., many on rural land.
- Two dozen states are considering legislation to ban or restrict data center development due to concerns over power strain and local grid reliability.
- The Data Center Coalition counters that data centers are efficient water users and that private transactions between landowners and buyers are voluntary.
...
**Title:** A New Foe Has Emerged for Data Centers: Farmers
**URL:** https://www.wsj.com/business/energy-oil/a-new-foe-has-emerged-for-data-centers-farmers-4a3eda8f
