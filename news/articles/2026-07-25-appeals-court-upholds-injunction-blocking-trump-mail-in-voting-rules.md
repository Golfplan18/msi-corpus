...
secondary_headline: 2-1 panel says states face 'rapidly approaching deadlines'
publish_date: '2026-07-25'
lede: A federal appeals court on Saturday upheld a lower court's injunction blocking
  President Donald Trump from implementing key parts of his executive order tightening
  mail-in voting rules in 23 states, rejecting the administration's argument that
  the legal challenge was premature.
nut_graf: The 2-1 ruling from the Boston-based 1st U.S. Circuit Court of Appeals keeps
  in place restrictions on the March executive order while litigation continues, ahead
  of November elections that will determine control of Congress.
primary_entities:
- Donald Trump
...
generation_timestamp: '2026-07-25T14:02:58-07:00'
source_cluster_id: cluster_guardian_2026-07-25_us-news-2026-jul-25-court-rejects-trump-
gdelt_event_ids: []
...
- slug: 2026-03-25-trump-votes-by-mail-in-florida-urges-congress-to-limit-the-practice
  ...
  strength: 0.6671
  confidence: medium
- slug: 2026-04-01-appeals-court-pauses-order-to-bring-voice-of-america-staff-back
  relation: related
  strength: 0.6371
  confidence: medium
draft: false
...
- slug: 2026-06-25-usps-to-refuse-delivery-of-mail-ballots-in-states-that-withhold-voter-rolls
  ...
  strength: 0.6943
---
## Appeals court upholds injunction blocking Trump mail-in voting rules

**Subtype:** fact

- The 1st U.S. Circuit Court of Appeals on Saturday upheld a lower court's injunction blocking President Trump's mail-in voting executive order in 23 states and the District of Columbia.
- The 2-1 ruling rejected the Justice Department's argument that the legal challenge was premature because government agencies had not yet finalized implementing policies.
- The panel wrote that the order "lays out a clear set of rapidly approaching deadlines" for the September primaries and November general election.
- U.S. District Judge Indira Talwani ruled in June that Trump lacked authority to direct the Department of Homeland Security to compile voter eligibility lists and that the U.S. Postal Service lacked authority to adopt binding mail-in voting regulations.
...
**Title:** Appeals court rejects Trump bid to curb mail-in voting in 23 states
