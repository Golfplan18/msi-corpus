...
secondary_headline: Intel shares more than quadruple under CEO Tan after government
  intervention
publish_date: '2026-07-11'
lede: The Trump administration converted $9 billion in federal grants into a 10% ownership
  stake in Intel and pressed Apple, Nvidia, and SpaceX to work with the chipmaker,
  part of what the Wall Street Journal described as an unprecedented government intervention
  in a private company's business.
nut_graf: The Journal described the effort as a striking example of state capitalism,
  with officials taking a hands-on approach that involved, according to the paper,
  twisting the arms of potential customers and partners to boost a company that had
  lost manufacturing credibility.
primary_entities:
- Intel
- Apple
- Nvidia
...
generation_timestamp: '2026-07-11T15:30:00Z'
...
- slug: 2026-05-13-trump-china-trip-includes-musk-apple-s-cook-nvidia-s-huang-and-boeing-ceo
  headline: Trump China trip includes Musk, Apple’s Cook, Nvidia’s Huang and Boeing
    CEO
  publish_date: '2026-05-13'
  relation: related
  strength: 0.6749
---
## Trump administration takes 10% stake in Intel; Apple, Nvidia sign deals

**Subtype:** fact

- The Trump administration converted $9 billion in federal grants into a 10% stake in Intel last year, according to the Wall Street Journal.
- Apple plans to use Intel for chip manufacturing after Trump and Commerce Secretary Howard Lutnick urged CEO Tim Cook to use Intel's fabs during tariff negotiations, the Journal reported, citing government officials.
- Nvidia announced it would invest $5 billion in Intel and buy its custom data center chips, according to the Journal.
- Elon Musk's SpaceX has also signed a deal with Intel since the government took its stake, the Journal reported.
...
**Title:** Washington’s Bet on Intel Is Starting to Pay Off
**URL:** https://www.wsj.com/business/washingtons-bet-on-intel-is-starting-to-pay-off-0072065b

### src_002 — The Wall Street Journal, national_daily, Tier 1, originating
**Author:** Keywords by Christopher Mims
**Publication date:** 2026-07-11
**Title:** The White House Made Fixing Intel Its Pet Project. It’s Working.
**URL:** https://www.wsj.com/tech/the-white-house-intel-trump-apple-84fe833e
