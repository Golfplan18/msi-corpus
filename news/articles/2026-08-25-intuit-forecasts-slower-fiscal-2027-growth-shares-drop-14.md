...
secondary_headline: CFO frames year as reset to reaccelerate with possible free TurboTax
  push
publish_date: '2026-08-25'
lede: Intuit forecast revenue growth of 9% to 10% for fiscal 2027 on Monday, slowing
  from 14% the prior year and missing Wall Street's projection of roughly 11%, according
  to FactSet. The Mountain View, California-based software company said it would deliberately
  accept short-term pressure on its do-it-yourself tax business to win new customers,
  with possible free offerings aimed at lower-income filers. Shares dropped about
  14% in after-hours trading.
nut_graf: The forecast lands as Intuit pivots toward an artificial-intelligence-first
  platform, a strategy that has already included a 17% workforce reduction announced
  in May with the resulting savings earmarked for what the company calls its 'big
  bets.'
primary_entities:
- Intuit
- Sandeep Aujla
...
generation_timestamp: '2026-08-25T14:09:39-07:00'
source_cluster_id: cluster_wsj_2026-08-25_orecasts-slower-growth-takes-steps-to-wi
gdelt_event_ids: []
...
- slug: 2026-08-07-wendy-s-withdraws-outlook-cuts-dividend-as-u-s-sales-drop-7
  relation: related
  confidence: medium
- slug: 2026-08-07-under-armour-cuts-revenue-outlook-as-north-america-sales-drop-9
  relation: related
  confidence: medium
...
- slug: 2026-05-20-target-sales-rise-5-6-under-new-ceo-as-outlook-stays-cautious
  relation: related
  confidence: medium
- slug: 2026-02-19-doordash-reports-revenue-orders-growth-but-warns-of-costly-tech-build
  relation: related
  confidence: medium
...
- slug: 2026-08-06-datadog-cites-lower-usage-from-major-ai-customer-in-2026-outlook
  ...
  strength: 0.671
- slug: 2026-08-05-applovin-shares-fall-17-after-revenue-misses-estimates-q3-adjusted-earnings-outl
  headline: AppLovin shares fall 17% after revenue misses estimates, Q3 adjusted earnings
    outlook comes in below forecast
  publish_date: '2026-08-05'
  relation: related
  strength: 0.6611
- slug: 2026-02-19-doordash-reports-revenue-orders-growth-but-warns-of-costly-tech-build
  headline: DoorDash reports revenue, orders growth but warns of costly tech build
...
- Intuit forecast fiscal 2027 revenue growth of 9% to 10%, missing Wall Street's projection of roughly 11%, according to FactSet.
- Chief Financial Officer Sandeep Aujla characterized the upcoming year as "a reset to reaccelerate."
- Intuit said it would pursue potential free TurboTax offerings targeting customers with adjusted gross incomes around $50,000.
- Intuit reported a fourth-quarter profit of $363 million, down from $381 million a year earlier, even as revenue rose 14% to $4.35 billion.
- Intuit's shares dropped about 14% in after-hours trading after the forecast; the stock had declined roughly 46% year-to-date.
