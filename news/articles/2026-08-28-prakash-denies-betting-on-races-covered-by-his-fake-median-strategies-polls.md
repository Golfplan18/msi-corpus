...
secondary_headline: Kalshi says its markets barely reacted to the fake polling figures
publish_date: '2026-08-28'
lede: Rahil Prakash, identified by The Guardian as the operator of the fake election-polling
  outfit Median Strategies, told NPR he placed no bets or trades on prediction markets
  tied to any of the races his fabricated polls covered. Two people familiar with
  his Kalshi trades said a company review found no wagers on those races, and a Polymarket
  employee said Prakash does not appear to have an account on that platform. The disclosure
  comes as Kalshi and Polymarket face heightened scrutiny over market manipulation
  ahead of November's midterm elections.
nut_graf: Prakash's denial undercuts immediate speculation that the stunt was an attempt
  to manipulate prediction markets, though broader concerns about the platforms' vulnerability
  to misinformation and insider trading ahead of the midterms persist.
primary_entities:
- Rahil Prakash
- Median Strategies
- Kalshi
...
generation_timestamp: '2026-08-28T01:08:51-07:00'
source_cluster_id: cluster_npr_2026-08-28_nx-s1-5945290-fake-poll-meridian-stratgies-kalshi-
gdelt_event_ids: []
...
- slug: 2026-08-13-cftc-probes-kalshi-mention-markets-after-white-house-teleprompter-bets
  ...
  strength: 0.7397
  confidence: medium
- slug: 2026-08-20-rahil-prakash-says-he-created-fake-election-polls-that-spread
  relation: related
  strength: 0.6828
  confidence: medium
...
related_stories:
- slug: 2026-08-20-rahil-prakash-says-he-created-fake-election-polls-that-spread
  headline: Rahil Prakash says he created fake election polls that spread
...
- Rahil Prakash, identified by The Guardian as the operator of the fake Median Strategies election-polling outfit, told NPR he placed no bets on prediction markets tied to the races covered by his fabricated polls; two people familiar with his Kalshi activity said a company review found no related wagers, and a Polymarket employee said Prakash does not appear to have an account on the platform.
- Prakash, 21, described the stunt as "a short-term social experiment" to see how fast fabricated figures would circulate, and said he was not trying to profit from the attention the polls attracted.
- Los Angeles Mayor Karen Bass promoted the fabricated poll across social media; after it was revealed as a sham, her campaign called for criminal prosecution of "bad faith attempts to influence elections."
- Kalshi spokesman Jack Such said the episode showed that while news outlets and campaigns touted the poll as real, prediction markets barely reacted to the fabricated figures.
- Better Markets' Amanda Fischer said election-related prediction markets are "very easily manipulated" and called for all such markets to be banned as contrary to the public interest.
