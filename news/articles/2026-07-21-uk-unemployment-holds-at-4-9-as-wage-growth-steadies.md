...
secondary_headline: Soft labor market data strengthens case for BOE rate hold
publish_date: '2026-07-21'
lede: The U.K. unemployment rate held at 4.9% in the three months through May, unchanged
  from the prior period and below the 5.0% economists had expected, the Office for
  National Statistics reported Tuesday. Wage growth excluding bonuses remained steady
  at 3.4% for a third consecutive month, reinforcing expectations that the Bank of
  England will leave its key interest rate unchanged when policymakers meet next week.
nut_graf: The data supports a view that the British economy is cooling without tipping
  into a sharp downturn — weak enough to dampen price pressures, but resilient enough
  that the central bank is not under pressure to cut rates. The figures offer the
  BOE breathing room as it weighs the risk that elevated energy prices stemming from
  the conflict in Iran could feed through to broader inflation against signs that
...
generation_timestamp: '2026-07-21T00:06:38-07:00'
source_cluster_id: cluster_wsj_2026-07-21_economy-u-k-unemployment-holds-steady-f2
gdelt_event_ids: []
...
- slug: 2026-06-29-two-mpc-members-vote-for-rate-hike-as-pill-says-2-8-inflation-is-problematic
  headline: Two MPC members vote for rate hike as Pill says 2.8% inflation is 'problematic'
...
---
## UK unemployment holds at 4.9% as wage growth steadies

**Subtype:** fact

- The U.K. unemployment rate held at 4.9% in the three months through May, unchanged from the prior period and below the 5.0% that economists had expected, the Office for National Statistics reported Tuesday.
- Annual wage growth excluding bonuses held steady at 3.4% for a third consecutive month, pointing to a stabilization of labor cost pressures for businesses.
- Suren Thiru, chief economist at the Institute of Chartered Accountants in England and Wales, said the figures point to a "fragile labor market" and "likely shut the door on a July interest rate rise."
- In a speech last week, Bank of England Gov. Andrew Bailey said the impact of higher energy prices from the conflict in Iran on U.K. inflation has so far been limited.
...
**Title:** U.K. Unemployment Holds Steady
**URL:** https://www.wsj.com/economy/u-k-unemployment-holds-steady-f2972aa4
