---
headline: FDA approves at-home STD tests and new gonorrhea drugs as infection rates fall
publish_date: '2026-01-12'
lede: The Food and Drug Administration last year cleared the first at-home test capable of detecting three sexually transmitted infections in women — gonorrhea, chlamydia and trichomoniasis — and approved two new drugs for gonorrhea, the first additions to that disease's treatment options in decades. The agency also approved a home-based screening kit for HPV, the virus that causes cervical cancer. The advances arrive as CDC provisional data show 2024 marked a third consecutive year of declining gonorrhea cases in the United States.
nut_graf: The new tests and drugs expand options for patients reluctant to seek care in clinical settings, sexual health experts said, though higher price tags, lack of insurance coverage and recent federal funding cuts to public health agencies could limit access for the populations most in need.
primary_entities:
...
generation_timestamp: '2026-05-23T00:05:19Z'
source_cluster_id: cluster_ap_2026-01-11_stds-fda-test-gonorreah-drug-visby-infec
gdelt_event_ids: []
...
figures_aggregate:
  ...
  sources: []
image:
  url: /articles/2026-01-12-fda-approves-at-home-std-tests-and-new-gonorrhea-drugs-as-infection-rates-fall.png
  alt: 'Illustration accompanying article: FDA approves at-home STD tests and new gonorrhea drugs as infection rates'
  source: ai_generated
cross_article_links: []
draft: false
---
...
- The Food and Drug Administration last year cleared the first at-home test capable of detecting three sexually transmitted infections in women — gonorrhea, chlamydia and trichomoniasis — and approved two new drugs for gonorrhea, the first additions to that disease's treatment options in decades.
...
- **Subject entities:** U.S. Food and Drug Administration; Visby Medical
- **Predicate:** approved
- **Object:** first at-home three-infection STD test for women (regulatory_action)
- **Temporal:** 2025-03
- **Sources:** src_001

> The FDA approved the first at-home test capable of detecting gonorrhea, chlamydia and trichomoniasis in women.

### c_002
- **Hedge:** confirmed
- **Corroboration:** single_source
- **Subject entities:** Visby Medical
- **Predicate:** uses
- **Object:** vaginal swab and photo-upload device with mobile app (product_feature)
- **Temporal:** 2025
- **Sources:** src_001

> The Visby Medical test uses a vaginal testing swab and a small testing device; users upload a photo of the device to view results on a mobile app.
...
> The Visby test costs $150 and is not covered by insurance.

### c_004
- **Hedge:** attributed
- **Corroboration:** single_source
- **Subject entities:** Visby Medical; Gary Schoolnik
- **Predicate:** takes
- **Object:** as little as six hours (time_duration)
- **Temporal:** 2026-01-12
- **Sources:** src_001

> The entire Visby test process — from purchase to prescription — can take as little as six hours, according to the company's chief medical officer.

### c_005
- **Hedge:** confirmed
- **Corroboration:** single_source
- **Subject entities:** U.S. Food and Drug Administration; Visby Medical
- **Predicate:** approved_based_on
- **Object:** 98% or higher accuracy (accuracy_rate)
- **Temporal:** 2025
- **Sources:** src_001

> The FDA approved the Visby test based on study results showing accuracy rates of around 98% or higher for all three infections.

### c_006
- **Hedge:** confirmed
- **Corroboration:** single_source
- **Subject entities:** U.S. Food and Drug Administration; Teal Health
- **Predicate:** approved
- **Object:** Teal Wand HPV home testing kit (regulatory_action)
- **Temporal:** 2025-05
- **Sources:** src_001

> The FDA approved Teal Health's HPV home testing kit, the Teal Wand, in May 2025.

### c_007
- **Hedge:** confirmed
- **Corroboration:** single_source
- **Subject entities:** federal health agencies
- **Predicate:** endorsed
- **Object:** self-collection for HPV screening (guideline_change)
- **Temporal:** 2026-01
- **Sources:** src_001

> Updated federal HPV screening guidelines released in early January 2026 endorsed self-collection for the first time.

### c_008
- **Hedge:** confirmed
- **Corroboration:** single_source
- **Subject entities:** U.S. Food and Drug Administration; Nuzolvenc; Bluejepa
- **Predicate:** approved
- **Object:** two new oral gonorrhea drugs (regulatory_action)
- **Temporal:** 2025
- **Sources:** src_001

> The FDA approved two new oral gonorrhea drugs — Nuzolvenc and Bluejepa — the first new treatment options for the disease in decades.

### c_009
- **Hedge:** confirmed
- **Corroboration:** single_source
- **Subject entities:** Nuzolvenc
- **Predicate:** developed_by
- **Object:** public-private partnership; granule formulation (drug_attribute)
- **Temporal:** 2025
- **Sources:** src_001

> Nuzolvenc was developed through a public-private partnership and comes in granules that dissolve in water.

### c_010
- **Hedge:** confirmed
- **Corroboration:** single_source
- **Subject entities:** Bluejepa; GlaxoSmithKline
- **Predicate:** approved_for
- **Object:** gonorrhea and urinary tract infections (drug_indication)
- **Temporal:** 2025
- **Sources:** src_001

> Bluejepa, made by GlaxoSmithKline, is a tablet also approved to treat urinary tract infections.
...
- **Predicate:** reported
- **Object:** third consecutive year of declining gonorrhea cases in 2024 (epidemiological_data)
- **Temporal:** 2024
- **Sources:** src_001

> The CDC's provisional data for 2024 showed a third consecutive year of fewer gonorrhea cases, and the second consecutive year of fewer adult chlamydia cases and the most infectious forms of syphilis.

### c_012
- **Hedge:** confirmed
- **Corroboration:** single_source
- **Subject entities:** Centers for Disease Control and Prevention
- **Predicate:** dropped_guidance
- **Object:** oral azithromycin for gonorrhea treatment (policy_change)
- **Temporal:** 2025
- **Sources:** src_001

> The CDC previously recommended azithromycin alongside ceftriaxone for gonorrhea but dropped the pill after detecting resistance.

### c_013
- **Hedge:** reported
- **Corroboration:** single_source
- **Subject entities:** Trump administration; Centers for Disease Control and Prevention
- **Predicate:** cut_funding
- **Object:** CDC and public health agency budgets (policy_action)
- **Temporal:** 2025-2026
- **Sources:** src_001

> The Trump administration cut funding to the CDC and other public health agencies.
...
**Title:** FDA-approved at-home tests available for common sexually transmitted diseases
**URL:** https://apnews.com/article/stds-fda-test-gonorreah-drug-visby-infection-2ff8c2ce9c757a2ad9eb599b291587ef
