...
- campaign finance
- use of public funds
- state-level political accountability
topic_tags:
- politics
storyline_nexus: []
...
generation_timestamp: '2026-08-27T13:05:50-07:00'
source_cluster_id: cluster_guardian_2026-08-27_rida-grand-jury-desantis-administration-
gdelt_event_ids: []
...
- A Florida grand jury concluded that the DeSantis administration "misappropriated" $10 million from a Medicaid settlement as part of a "sophisticated scheme to fund political activities."
- The funds were transferred to the Hope Florida Foundation, a charity with ties to First Lady Casey DeSantis, then reportedly "funneled" into two political action committees.
- The grand jury found "insufficient evidence to charge anyone criminally" but said no witness took responsibility for the original transfer decision.
- The report recommended the Florida legislature enact a law requiring all state money to be deposited into General Revenue.
