...
secondary_headline: U.S. shipyard capacity constraints drive formal outreach to allied
  yards
publish_date: '2026-07-14'
lede: The U.S. Navy has requested information from major South Korean shipbuilders
  on their ability to design and build destroyers and fleet support vessels, a move
  that could open the world's largest naval market to South Korea's shipbuilding industry.
  The requests mark a significant step in Washington's effort to address shipyard
  capacity constraints and strengthen the maritime industrial base with allied help.
nut_graf: The Navy's outreach comes as expanding U.S. naval construction and modernization
  spending could reach roughly $1.2 trillion over the long term, according to industry
  estimates cited in South Korea, dwarfing Seoul's recent efforts to win Canada's
  next-generation submarine program. The prospective U.S. market represents both a
  major commercial opportunity and a test of Seoul's ability to coordinate industrial
  policy with security diplomacy.
primary_entities:
- United States Navy
...
generation_timestamp: '2026-07-14T17:18:23-07:00'
source_cluster_id: cluster_upi_2026-07-14_top-news-world-news-2026-07-14-shipbuild
gdelt_event_ids: []
...
- slug: 2026-06-09-south-korea-us-align-on-nuclear-powered-submarine-plan
  ...
  strength: 0.7
---
## Navy seeks South Korean shipbuilders for destroyers, support vessels

**Subtype:** fact

- The U.S. Navy issued requests for information to South Korean shipbuilders regarding the design and construction of destroyer-class surface combatants and medium-sized fleet tankers.
- HD Hyundai Heavy Industries and Hanwha Ocean responded to requests covering both destroyers and support vessels; Samsung Heavy Industries submitted information on fleet replenishment ships.
- U.S. law generally requires Navy vessels to be built in American shipyards, meaning congressional action or a national security exemption would be needed before a warship could be constructed in South Korea.
- The outreach is part of the MASGA bilateral initiative, and the two governments signed a memorandum in May establishing a formal shipbuilding partnership.
...
**Title:** U.S. Navy inquiries open door for South Korean shipbuilders
**URL:** https://www.upi.com/Top_News/World-News/2026/07/14/shipbuilders-us-navy/9191784072775/
