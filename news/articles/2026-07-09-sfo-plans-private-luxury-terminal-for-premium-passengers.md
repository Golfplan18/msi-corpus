...
secondary_headline: Terminal would serve commercial flights with private TSA and customs
  screening
publish_date: '2026-07-09'
lede: San Francisco International Airport is planning to build a private luxury terminal
  exclusively for passengers who pay a premium, with the airport accepting bids from
  private operators this fall and aiming to open the terminal in late 2028.
nut_graf: The terminal reflects growing demand for high-end travel experiences at
  major airports. SFO would become the next major American airport to offer a private
  terminal, following airports in Los Angeles, London, and Paris that have already
  opened one.
primary_entities:
...
generation_timestamp: '2026-07-09T08:18:19-07:00'
source_cluster_id: cluster_guardian_2026-07-09_us-news-2026-jul-09-san-francisco-airpor
gdelt_event_ids: []
...
- slug: 2026-04-01-faa-cuts-sfo-arrivals-from-54-to-36-an-hour-as-delays-loom
  headline: FAA cuts SFO arrivals from 54 to 36 an hour as delays loom
  publish_date: '2026-04-01'
  relation: related
  strength: 0.67
---
## SFO plans private luxury terminal for premium passengers

**Subtype:** fact

- San Francisco International Airport is seeking bids to build a private luxury terminal for premium commercial passengers, with a contract award expected by December and opening targeted for late 2028.
- The 75,000-square-foot terminal will feature private TSA and Customs and Border Protection lines, with valet service from the terminal to the aircraft.
- Airport spokesperson Doug Yakel said the terminal will allow premium passengers to avoid seeing other travelers until boarding.
- The terminal will be operated by a private company on a membership or per-use basis, with pricing set by the winning bidder.
