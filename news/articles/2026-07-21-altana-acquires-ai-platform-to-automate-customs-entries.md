...
secondary_headline: Deal could exceed $100M as tariff changes increase entry volumes
publish_date: '2026-07-21'
lede: Trade technology provider Altana said Tuesday it is acquiring Cervo AI, an artificial-intelligence
  platform that automates the process of writing customs entries, in a deal that could
  be worth more than $100 million in cash and equity if certain performance milestones
  are reached.
nut_graf: U.S. Customs and Border Protection has processed over 63 million entry summaries
  so far this fiscal year, a volume already 27% higher than all of last year and up
  65% from fiscal 2024, as shifting tariffs and trade enforcement increase documentation
...
source_cluster_id: cluster_wsj_2026-07-21_port-altana-acquires-ai-platform-to-tack
gdelt_event_ids: []
...
related_stories: []
---
## Altana acquires AI platform to automate customs entries

**Subtype:** fact

- Altana said Tuesday it is acquiring Cervo AI, an AI platform that automates customs entry writing, in a deal that could exceed $100 million in cash and equity if certain performance milestones are reached.
- U.S. Customs and Border Protection has processed over 63 million entry summaries this fiscal year, a 27% increase from all of last year and 65% above fiscal 2024.
- Temporary U.S. tariffs implemented in February are due to expire Friday, while the U.S. recently declined to extend its trade pact with Mexico and Canada.
- Altana CEO Evan Smith said trade volatility is leading companies to seek more efficient import handling.
...
**Title:** Altana Acquires AI Platform to Tackle Customs Complexity
**URL:** https://www.wsj.com/logistics-report/altana-acquires-ai-platform-to-tackle-customs-complexity-0bf30fa2
