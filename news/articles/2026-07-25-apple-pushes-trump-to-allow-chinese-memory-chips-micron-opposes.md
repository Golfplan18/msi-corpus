...
secondary_headline: Decision forces president to choose between consumer prices and
  domestic chip production
publish_date: '2026-07-25'
lede: Apple is lobbying the Trump administration to let it use Chinese memory chips
  in products sold outside the U.S., while Micron Technology is pushing to block the
  move, according to people familiar with the discussions. Apple CEO Tim Cook and
  other top executives have pitched the plan to President Trump, Commerce Secretary
  Howard Lutnick, and Treasury Secretary Scott Bessent. Micron executives, including
  CEO Sanjay Mehrotra, have warned that allowing the Chinese chips would threaten
  the domestic industry.
nut_graf: The fight puts Trump at the center of a conflict between two of his top
  economic priorities — cutting prices for consumers and boosting U.S. semiconductor
  manufacturing — and between two companies that have cultivated close ties with his
  administration.
primary_entities:
- Apple
- Micron Technology
...
generation_timestamp: '2026-07-24T19:08:39-07:00'
source_cluster_id: cluster_wsj_2026-07-24_tech-trump-apple-micron-china-chips-784b
gdelt_event_ids: []
...
- Apple is lobbying the Trump administration for permission to use Chinese memory chips from blacklisted manufacturers CXMT and YMTC in its products sold outside the U.S., according to people familiar with the discussions.
- Micron Technology, the only major U.S. memory chip maker, is urging officials to block the plan, warning it could destroy the domestic industry.
- The dispute puts President Trump in the middle of a conflict between two top economic priorities — reducing consumer prices and expanding domestic semiconductor production.
- Apple argues the move would alleviate a global memory chip shortage and reduce costs for American consumers; Micron contends it can expand domestic production fast enough to meet demand.
- Both Chinese chipmakers are designated as Chinese military companies by the Pentagon, and YMTC is also on a trade blacklist.
- Both companies have deep ties to the administration, with Apple CEO Tim Cook and Micron CEO Sanjay Mehrotra having traveled with Trump to China earlier this year and contributed funding to Trump-backed initiatives.
...
**Title:** Trump Caught Between Apple and Micron in Fight Over Chinese Chips
