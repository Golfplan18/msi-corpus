---
headline: Budapest pizzeria recreates ancient Roman flatbread using historical ingredients
publish_date: '2026-02-21'
lede: In Budapest, Neverland Pizzeria is inviting diners to experience what pizza-like food might have tasted like in ancient Rome, using only ingredients available to Romans two millennia ago. Founder József Zara and head chef Gergely Bárdossy created the limited-edition flatbread without tomatoes, mozzarella or any ingredients from the Americas—products unknown in Europe until centuries after the Roman Empire.
nut_graf: The project, sparked by a 2023 archaeological discovery in Pompeii, illustrates a growing interest in how ancient culinary practices can inform contemporary food culture. The experiment demonstrates the intersection of archaeology, history and modern hospitality.
primary_entities:
- Neverland Pizzeria
- József Zara
- Gergely Bárdossy
...
source_cluster_id: cluster_ap_2026-02-24_hungary-ancient-rome-pizza-896056031e340
gdelt_event_ids: []
...
**Subject entities:** Neverland Pizzeria; József Zara
**Predicate:** created
**Object:** limited-edition ancient Rome-inspired flatbread (food_product)
**Temporal:** 2026-02-21
**Source IDs:** src_001

> Neverland Pizzeria in Budapest created a limited-edition flatbread using only ingredients available in ancient Rome.

### c_002 — reported, single source
**Subject entities:** tomatoes; Europe
**Predicate:** arrived_in
**Object:** centuries after Roman Empire (temporal_relation)
**Source IDs:** src_001

> Tomatoes arrived in Europe from the Americas centuries after the Roman Empire.

### c_003 — reported, single source
**Subject entities:** mozzarella
**Predicate:** unknown_in
**Object:** Roman times (historical_period)
**Source IDs:** src_001

> Mozzarella was unknown in Roman times.

### c_004 — reported, single source
**Subject entities:** Romans; thermopolia
**Predicate:** ate_and_sold
**Object:** oven-baked flatbreads topped with herbs, cheeses, sauces (food_product)
**Source IDs:** src_001

> Romans ate oven-baked flatbreads topped with herbs, cheeses and sauces, which were often sold in ancient Roman snack bars called thermopolia.

### c_005 — appears, single source
**Subject entities:** archaeologists; Pompeii
**Predicate:** uncovered_fresco
**Object:** focaccia-like flatbread with pomegranate, dates, spices, pesto-like spread (archaeological_finding)
**Temporal:** 2023
**Source IDs:** src_001

> In 2023, archaeologists uncovered a fresco in Pompeii depicting a focaccia-like flatbread topped with what appear to be pomegranate seeds, dates, spices and a pesto-like spread.

### c_006 — reported, single source
**Subject entities:** József Zara; De re coquinaria
**Predicate:** consulted
**Object:** German historian and ancient cookbook (research_source)
**Source IDs:** src_001

> József Zara consulted a historian in Germany and the ancient cookbook De re coquinaria, thought to have been authored around the 5th century.

### c_007 — reported, single source
**Subject entities:** Gergely Bárdossy; fermented spinach juice
**Predicate:** used
**Object:** fermented spinach juice for dough leavening (cooking_technique)
**Source IDs:** src_001

> Head chef Gergely Bárdossy used fermented spinach juice to help the dough rise, substituting for a water system that did not exist in Roman times.

### c_008 — reported, single source
**Subject entities:** dough; einkorn; spelt
**Predicate:** uses
**Object:** einkorn and spelt ancient grains (ingredient)
**Source IDs:** src_001

> The dough uses einkorn and spelt, ancient grains widely cultivated in Roman times.

### c_009 — reported, single source
**Subject entities:** flatbread
**Predicate:** topped_with
**Object:** epityrum, garum, confit duck leg, toasted pine nuts, ricotta, grape reduction (ingredient_list)
**Source IDs:** src_001

> The flatbread is topped with epityrum, garum, confit duck leg, toasted pine nuts, ricotta and grape reduction.

### c_010 — attributed, single source
**Subject entities:** Neverland Pizzeria; József Zara
**Predicate:** combines
**Object:** experimentation with tradition (business_philosophy)
**Source IDs:** src_001

> Neverland Pizzeria's philosophy combines experimentation with tradition.

### c_011 — attributed, single source
**Subject entities:** Neverland Pizzeria
**Predicate:** does_not_use
**Object:** pineapple (ingredient_policy)
**Source IDs:** src_001

> The restaurant does not use pineapple on its pizzas.
