...
secondary_headline: Merger deal includes roughly $650 million quarterly ticking fee
publish_date: '2026-07-24'
lede: Paramount said Friday it will not proceed with its $81 billion merger with Warner
  Bros. Discovery until legal challenges to the deal are resolved or June 1, 2027,
  pausing a Hollywood combination that has drawn antitrust lawsuits from 12 states
  and the Writers Guild of America.
nut_graf: The pause delays a merger that would combine two major Hollywood studios,
  the CBS broadcast network, dozens of cable channels including CNN, and streaming
  services Paramount+ and HBO Max under a single parent company — a combination that
  state attorneys general and the Writers Guild of America argue would reduce competition
...
source_cluster_id: cluster_wsj_2026-07-24_siness-media-paramount-agrees-to-pause-i
gdelt_event_ids: []
...
- slug: 2026-06-30-comcast-shares-rise-7-on-plan-to-spin-off-nbcuniversal
  ...
  strength: 0.6266
  confidence: medium
- slug: 2026-07-07-getty-terminates-3-7b-shutterstock-merger-over-uk-antitrust-condition
  relation: related
  strength: 0.6219
  confidence: medium
draft: false
...
- slug: 2026-04-24-warner-bros-shareholders-approve-paramount-s-81-billion-takeover
  ...
  strength: 0.8386
---
## Paramount agrees to pause Warner Bros. merger until June 2027

**Subtype:** fact

- Paramount said Friday it will not proceed with its $81 billion merger with Warner Bros. Discovery until legal challenges are resolved or June 1, 2027, whichever comes first.
- Twelve states and the Writers Guild of America are challenging the deal on antitrust grounds, arguing it would reduce competition and raise prices for consumers.
- Paramount called the agreement "a direct path to a trial based on the evidence" and said the transaction is "good for competition, good for consumers, and good for creators."
- The merger agreement includes a quarterly ticking fee of roughly $650 million for Warner shareholders beginning in October until the transaction closes.
- U.S. District Judge Araceli Martínez-Olguín said the combined market share of the two studios "has persuaded the court that it can presume the proposed merger is likely to violate antitrust laws."
...
**Title:** Paramount Agrees to Pause Its Warner Bros. Merger
