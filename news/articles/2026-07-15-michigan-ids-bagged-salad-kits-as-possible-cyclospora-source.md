...
secondary_headline: Over 5,100 possible cases across 34 states under CDC investigation
publish_date: '2026-07-15'
lede: Michigan health officials have identified bagged, prewashed salad kits as a
  possible culprit in a rapidly expanding Cyclospora outbreak that has sickened thousands,
  as the U.S. Centers for Disease Control and Prevention investigates more than 5,100
  possible cases across 34 states.
nut_graf: The identification of a potential source — lettuce in prewashed salad kits
  — marks a concrete step in the investigation, but health officials cautioned that
  the findings are preliminary and that the complex supply chain for leafy greens
  makes it difficult to pinpoint a single origin for the parasite causing the outbreak.
primary_entities:
- Michigan
...
generation_timestamp: '2026-07-15T06:18:33-07:00'
source_cluster_id: cluster_wsj_2026-07-15_alth-healthcare-diarrhea-outbreak-cyclos
gdelt_event_ids: []
...
- slug: 2026-07-03-cdc-probes-cyclospora-outbreak-with-over-400-cases-across-18-states
  ...
  strength: 0.7795
---
## Michigan IDs bagged salad kits as possible Cyclospora source

**Subtype:** fact

- Michigan health officials identified bagged, prewashed salad kits as a possible source of the Cyclospora outbreak, with more than 3,300 cases in the state as of Tuesday.
- The CDC reported more than 5,100 possible cases across 34 states and more than 140 hospitalizations.
- Taco Bell has voluntarily removed limited fresh ingredients at select restaurants but said no link has been confirmed to its food.
- Dr. Natasha Bagdasarian, Michigan's chief medical executive, said federal funding cuts have left public health agencies stretched thin during the response.
...
**Title:** Health Officials Zero In on Lettuce in Explosive-Diarrhea Outbreak Probe
**URL:** https://www.wsj.com/health/healthcare/diarrhea-outbreak-cyclospora-lettuce-michigan-81087d03
