...
secondary_headline: FDA cleared LifeVac as backup only after traditional methods fail
publish_date: '2026-09-09'
lede: Anti-choking devices are entering American schools through state laws, school-district
  purchases and donations from the industry's dominant manufacturer, even though the
  American Heart Association and American Red Cross have not endorsed the devices
  in their published choking-rescue guidelines. Texas and New York City have enacted
  laws requiring schools to stock the devices, and at least nine other states are
  weighing similar bills, The Wall Street Journal reported Wednesday.
nut_graf: About 5,000 people die from choking in the United States each year, and
  choking is one of the leading causes of pediatric death, according to the Journal.
primary_entities:
- LifeVac
- Arthur Lih
...
storyline_continuity:
  ...
  selected_prior_ids: []
  evaluated_prior_ids:
  - 2026-07-16-fda-approves-merck-s-lipfendra-first-oral-pcsk9-inhibitor
...
generation_timestamp: '2026-09-09T03:51:47-07:00'
source_cluster_id: cluster_wsj_2026-09-09_ti-choking-devices-are-entering-americas
gdelt_event_ids: []
...
figures_aggregate:
  ...
  sources: []
cross_article_links:
- slug: 2026-09-01-dyson-launches-499-ai-powered-camerajet-its-first-oral-care-product
  relation: related
  strength: 0.5858
  confidence: medium
...
- slug: 2026-08-13-teens-build-tech-free-alternatives-as-school-phone-bans-spread
  ...
  strength: 0.5823
  confidence: medium
- slug: 2026-07-07-democratic-project-2029-takes-on-annoyance-economy-with-consumer-protections
  relation: related
  strength: 0.5622
  confidence: medium
...
- slug: 2026-06-05-nyc-consumer-watchdog-takes-on-junk-fees-and-deceptive-subscriptions
  ...
  strength: 0.5674
  confidence: medium
- slug: 2026-06-06-more-young-concertgoers-embrace-earplugs-to-prevent-hearing-loss
  relation: related
  strength: 0.5629
  confidence: medium
...
- slug: 2026-05-15-pennsylvania-district-rejects-parent-push-to-let-students-opt-out-of-classroom-l
  ...
  strength: 0.5767
  confidence: medium
- slug: 2026-05-25-life-insurer-john-hancock-turns-healthy-habits-into-a-points-game
  relation: related
  strength: 0.564
  confidence: medium
...
- LifeVac, the leading U.S. anti-choking device maker, has donated more than 10,000 devices to schools as Texas and New York City have enacted laws requiring schools to stock them.
- The FDA authorized LifeVac in March as a second-line tool, to be used only after the Heimlich maneuver and back blows have failed.
- The American Heart Association and American Red Cross have declined to include the devices in their choking guidelines, citing insufficient evidence.
- An 8-year-old Texas boy died in February after choking on a grape at school despite multiple rescue attempts that included a LifeVac device.
