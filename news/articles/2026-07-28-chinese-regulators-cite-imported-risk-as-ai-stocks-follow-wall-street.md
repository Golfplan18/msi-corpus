...
secondary_headline: Korean chipmaker swings rattle Chinese tech through sentiment,
  not capital
publish_date: '2026-07-28'
lede: Chinese regulators acknowledged that the country's stock market swings are being
  driven by sentiment in the United States and South Korea, undercutting Beijing's
  long-running narrative of technological self-reliance, The Wall Street Journal reported.
  A fund manager told WSJ that mainland stock moves are 'driven by the AI trade in
  the United States,' and regulators pointed to 境外输入性风险, or risk imported from abroad,
  as the culprit behind a selloff this month.
nut_graf: Tracking Chinese tech valuations against U.S. and Korean sentiment reveals
  the gap between Beijing's ambition to build an independent AI industry and the market
  logic that still ties Chinese stocks to global capital flows. Analysts said Chinese
  tech stocks are more stretched than their Korean counterparts, resting on a domestic-substitution
  story that assumes China's champions deserve to trade like Nvidia's ecosystem without
  Nvidia's numbers behind them.
primary_entities:
- China
- United States
- South Korea
...
generation_timestamp: '2026-07-28T04:15:08-07:00'
source_cluster_id: cluster_wsj_2026-07-28_d-china-china-wants-ai-independence-its-
gdelt_event_ids: []
...
- Chinese regulators cited "risk imported from abroad" (境外输入性风险) after a selloff in Chinese stocks this month, acknowledging the market's dependence on U.S. and South Korean sentiment.
- State investment arm Huijin bought broad-based ETFs to stabilize the market, but analysts said the tech sector's recovery depends on sentiment holding steady in the U.S. and Korea.
- Chipmaker CXMT raised $8.55 billion in China's largest IPO in over 15 years, reaching a $484 billion valuation, but the rally stalled as blowout earnings from a global supply shortage were already priced in.
- DeepSeek founder Liang Wenfeng said AI could account for 10% of global GDP, arguing the technology's spoils are too large for any company or country to keep to itself.
