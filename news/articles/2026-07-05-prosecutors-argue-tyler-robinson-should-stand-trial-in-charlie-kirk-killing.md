...
secondary_headline: Alleged text confession to be presented at hearing
publish_date: '2026-07-05'
lede: Prosecutors are set to begin presenting evidence Monday in a five-day preliminary
  hearing for Tyler Robinson, the 23-year-old accused of killing conservative activist
  Charlie Kirk. Robinson has not entered a plea in the case, which carries the possibility
  of the death penalty if it proceeds to trial.
nut_graf: The hearing marks the most substantial presentation of evidence in the case
  so far and will be the first time Kirk's family is in the same courtroom as the
  defendant. The judge will decide whether the case goes to trial.
primary_entities:
- Tyler Robinson
- Charlie Kirk
- Erika Kirk
...
generation_timestamp: '2026-07-05T00:17:26-07:00'
source_cluster_id: cluster_ap_2026-07-05_charlie-kirk-robinson-utah-assassination
gdelt_event_ids: []
...
draft: false
image:
  url: /articles/2026-07-05-prosecutors-argue-tyler-robinson-should-stand-trial-in-charlie-kirk-killing.png
  alt: 'Illustration accompanying article: Prosecutors argue Tyler Robinson should
    stand trial in Charlie Kirk killing'
...
- slug: 2026-05-09-judge-rejects-bid-to-ban-courtroom-cameras-from-charlie-kirk-murder-case
  ...
  strength: 0.7626
---
## Prosecutors argue Tyler Robinson should stand trial in Charlie Kirk killing

**Subtype:** fact

- Prosecutors will present evidence against Tyler Robinson in a five-day preliminary hearing starting July 6 in a Utah court.
- Robinson, 23, is charged with aggravated murder in the Sept. 10 killing of Turning Point USA co-founder Charlie Kirk at Utah Valley University.
- Kirk's widow Erika Kirk and his parents are expected to attend the hearing, which will be livestreamed.
- Prosecutors allege Robinson sent a text message confession to his partner and left a note stating his intent to kill one of the nation's leading conservative voices.
...
**Title:** Tyler Robinson faces court in Charlie Kirk assassination case at Utah Valley University
...
**Publication date:** 2026-07-05
**Title:** Prosecutors to present case against the man accused of killing Charlie Kirk
