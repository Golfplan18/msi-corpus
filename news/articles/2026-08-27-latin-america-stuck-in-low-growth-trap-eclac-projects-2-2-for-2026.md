...
secondary_headline: Nearly half of region's workers remain in informal jobs, ECLAC
  finds
publish_date: '2026-08-27'
lede: Latin America's regional economy is projected to grow 2.2% in 2026, the United
  Nations' Economic Commission for Latin America and the Caribbean said, marking a
  fifth consecutive year of growth averaging around 2.3%. The commission, known as
  ECLAC, described the situation as a 'low-growth-capacity trap' and warned the pace
  is insufficient to produce sustained gains in per capita income. Economist César
  Addario Soljancic wrote in a UPI Voices column published Aug. 27 that digital adoption,
  nearshoring and the energy transition offer the region's most promising paths forward.
nut_graf: Latin America's prolonged growth weakness predates the pandemic and reflects
  persistent structural issues including stagnating productivity, weak investment,
  and a large informal economy. ECLAC's Aug. 20 report recommended using digitalization
  and administrative interoperability to simplify compliance and formalize more of
  the labor force.
primary_entities:
...
generation_timestamp: '2026-08-27T07:05:47-07:00'
source_cluster_id: cluster_upi_2026-08-27_-08-27-latam-perspectives-low-growth-cap
gdelt_event_ids: []
...
- slug: 2026-04-28-colombia-climate-conference-spotlights-finance-squeeze-slowing-fossil-fuel-shift
  ...
  strength: 0.6138
  confidence: medium
- slug: 2026-02-03-latin-america-pushes-back-against-a-flood-of-cheap-chinese-goods
  relation: related
  strength: 0.6521
  confidence: medium
draft: false
...
- ECLAC projects Latin American regional growth at 2.2% in 2026, marking a fifth consecutive year averaging around 2.3%.
- ECLAC describes the situation as a "low-growth-capacity trap" insufficient to produce sustained per capita income gains.
- ECLAC data show Latin America grew just 0.3% annually between 2014 and 2019, then contracted roughly 6.8% in 2020 — the steepest downturn in a century.
- The commission's Aug. 20 report tied the low-growth trap to the informal economy, where nearly half of the region's workers remain employed.
- Economist César Addario Soljancic wrote in UPI's Voices column that digital adoption, nearshoring and the energy transition offer paths to higher productivity.
- A Mastercard-backed survey found 89% of consumers across 10 Latin American countries now qualify as digital users.
