...
secondary_headline: Gene therapy for deafness given away free in statement on industry
  purpose
publish_date: '2026-07-24'
lede: Regeneron Pharmaceuticals co-founder and chief scientific officer George Yancopoulos
  is betting on the company's internal research pipeline rather than acquisitions
  to replace revenue from drugs facing competitive pressure, according to an interview
  with The Wall Street Journal. The strategy comes as the company's flagship eye drug
  Eylea, which generated roughly 80% of revenue at its peak, faces increasing competition
  and another blockbuster, Dupixent, begins to lose patent protection in the early
  2030s.
nut_graf: 'With more than $18 billion in cash on its balance sheet, Regeneron is in
  a stronger position than many rivals to acquire smaller biotechs. But Yancopoulos,
  who holds more than 1,000 patents worldwide and has authored over 500 scientific
  papers, is instead pursuing the broadest pipeline in the company''s history — about
  60 drugs under development spanning oncology, Alzheimer''s, Parkinson''s and obesity.
  The approach reflects the company''s founding philosophy: generate breakthroughs
  from its own labs rather than buy them.'
primary_entities:
...
generation_timestamp: '2026-07-24T11:05:15-07:00'
source_cluster_id: cluster_wsj_2026-07-24_health-pharma-regeneron-george-yancopoul
gdelt_event_ids: []
...
- slug: 2026-07-10-u-s-biotechs-tighten-secrecy-to-beat-chinese-fast-follower-drugs
  relation: related
  confidence: medium
- slug: 2026-07-13-appeals-court-revives-500-plus-lawsuits-alleging-tylenol-autism-link
  relation: related
  confidence: medium
...
- slug: 2026-06-28-greenwater-services-partly-owned-by-trump-s-friend-cafaro-lands-1-7m-no-bid-pool
  relation: related
  confidence: medium
- slug: 2026-06-23-seed-patents-stifle-competition-divert-farm-subsidies-doj-says
  relation: related
  confidence: medium
- slug: 2026-06-16-janelia-bets-on-transparent-fish-with-ai-to-decode-brain-behavior-link
  relation: related
  confidence: medium
...
- slug: 2026-05-17-carfentanil-100-times-stronger-than-fentanyl-surges-across-u-s
  relation: related
  confidence: medium
- slug: 2026-05-18-macron-s-davos-sunglasses-spark-viral-memes-and-market-surge
  relation: related
  confidence: medium
...
related_stories:
- slug: 2026-04-24-trump-and-regeneron-unveil-a-drug-pricing-deal-for-medicaid-trumprx
  headline: Trump and Regeneron unveil a drug pricing deal for Medicaid, TrumpRx
...
- Regeneron co-founder and chief scientific officer George Yancopoulos is betting on the company's internal pipeline of about 60 drugs rather than acquisitions to replace revenue from Eylea and Dupixent, which face competitive pressure and patent expirations.
- Yancopoulos holds more than 1,000 patents worldwide, including 77 granted in the U.S., and has authored more than 500 scientific papers.
- The company, with a market capitalization of roughly $70 billion and more than $18 billion in cash, has seen its stock fall more than 15% year-to-date after two late-stage drug failures since the start of 2025.
- Regeneron gave away a gene therapy that restores hearing to children born with a rare genetic deafness, affecting fewer than 50 U.S. newborns a year; Yancopoulos said the company did it "to make a statement."
