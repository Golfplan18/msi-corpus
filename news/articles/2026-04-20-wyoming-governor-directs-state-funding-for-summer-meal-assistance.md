---
headline: Wyoming governor directs state funding for summer meal assistance
publish_date: '2026-04-20'
lede: 'Gov. Mark Gordon signed an executive order Wednesday directing the state to implement a federal summer meal assistance program for Wyoming children, moving unilaterally after the legislature rejected the initiative three times in as many years.
