...
secondary_headline: Proposed rule change curtails tribal consultation, public comment
publish_date: '2026-07-23'
lede: The Advisory Council on Historic Preservation, a federal agency where 21 of
  24 members are Trump appointees, is voting by email this week on proposed regulatory
  changes that critics say would narrow the scope of historic properties protected
  under federal law, eliminate mandatory public comment, and remove the requirement
  to consult with Native American tribes on federally funded construction projects.
nut_graf: The revisions to the Section 106 review process — created by the National
  Historic Preservation Act of 1966 after urban renewal and highway construction destroyed
  landmarks like New York's Penn Station — would apply nationwide and affect the more
  than 100,000 properties on the National Register of Historic Places, encompassing
  over 1.8 million buildings, structures, sites, objects and districts.
primary_entities:
- United States
...
generation_timestamp: '2026-07-23T21:00:17.264521Z'
source_cluster_id: cluster_npr_2026-07-23_nx-s1-5904435-section-106-review-trump-historic-pr
gdelt_event_ids: []
...
- The Advisory Council on Historic Preservation, where 21 of 24 members are Trump appointees, is voting by email this week on proposed revisions to Section 106 of the National Historic Preservation Act that would redefine which properties qualify as historic and remove the requirement for public comment.
- Proposed changes would exclude "significant landscape features" like the Grand Canyon from historic property designations, eliminate mandatory tribal consultation, and exempt large categories of federally funded state and local projects from review.
- Critics including Greg Werkheiser of Cultural Heritage Partners and former council chair Sara Bronin say the revisions could allow highway widenings and other projects to destroy historic sites without public notice or community input.
- The Section 106 process was enacted in 1966 after urban renewal and highway construction destroyed landmarks like Penn Station and devastated historically Black neighborhoods.
