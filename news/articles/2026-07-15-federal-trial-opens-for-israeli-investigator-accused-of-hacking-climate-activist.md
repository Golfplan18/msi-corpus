---
headline: Federal trial opens for Israeli investigator accused of hacking climate
  activists
secondary_headline: Forlit pleaded not guilty to hacking, wire fraud charges in New
  York
publish_date: '2026-07-15'
lede: Israeli private investigator Amit Forlit is on trial in New York federal court
  on hacking and wire fraud charges connected to a multi-year scheme that targeted
  climate activists. Federal prosecutors allege the operation was commissioned by
  a lobbying firm representing ExxonMobil, a connection at the center of a case that
  climate advocates hope will reveal who directed and paid for the hacking.
nut_graf: Forlit's trial offers the closest look yet at who paid for and directed
  a hacking campaign that breached the accounts of climate researchers, environmental
  lawyers, and activists beginning around 2015. Neither ExxonMobil nor DCI Group has
  been accused of wrongdoing; both deny any involvement.
primary_entities:
- Amit Forlit
- ExxonMobil
- DCI Group
...
generation_timestamp: '2026-07-15T07:43:45-07:00'
source_cluster_id: cluster_guardian_2026-07-15_ng-interactive-2026-jul-15-climate-activ
gdelt_event_ids: []
...
figures_aggregate:
  ...
  sources: []
cross_article_links:
- slug: 2026-06-10-fossil-fuel-funded-judicial-seminars-target-climate-litigation
  relation: related
  strength: 0.6246
  confidence: medium
...
related_stories: []
---
## Federal trial opens for Israeli investigator accused of hacking climate activists

**Subtype:** fact

- Amit Forlit, an Israeli private investigator, is on trial in New York federal court on hacking and wire fraud charges related to a scheme targeting climate activists.
- Federal prosecutors allege the hacking was commissioned by DCI Group, a lobbying firm representing ExxonMobil, according to an unsealed indictment.
- The hacking campaign breached the accounts of climate advocates, with victims including Rockefeller Family Foundation director Lee Wasserman, Climate Investigations Center founder Kert Davies, and Conservation Law Foundation president Bradley Campbell.
- Neither ExxonMobil nor DCI Group has been accused of wrongdoing; both deny involvement in the hacking.
