...
nut_graf: Connecticut is among a small number of states — including Maryland, California, and New Mexico — that have committed state funds to offset part of the federal subsidy loss. Gov. Ned Lamont announced $70 million in state relief for 2026, drawn from a $500 million emergency response fund created during a special legislative session to address federal cuts, with additional funding planned for 2027.
primary_entities:
- Ned Lamont
- James Michel
- Access Health CT
...
generation_timestamp: '2026-05-23T00:01:31Z'
source_cluster_id: cluster_ap_2026-01-07_ned-lamont-connecticut-james-michel-subs
gdelt_event_ids: []
...
figures_aggregate:
  ...
  sources: []
image:
  url: /articles/2026-01-08-connecticut-weighs-enrollment-extension-as-aca-subsidy-lapse-spikes-premiums.png
  alt: 'Illustration accompanying article: Connecticut weighs enrollment extension as ACA subsidy lapse spikes premiums'
  source: ai_generated
cross_article_links: []
draft: false
---
...
- The pandemic-era enhanced subsidies had been in place since 2021.
- Connecticut officials said Thursday they are considering extending the state's 2026 Affordable Care Act open enrollment deadline by one to two months, citing ongoing uncertainty over whether Congress will revive enhanced premium subsidies that lapsed Dec.
- "One of the potential changes out there is what the feds are doing.
- Connecticut is among a small number of states — including Maryland, California, and New Mexico — that have committed state funds to offset part of the federal subsidy loss.
...
- **Subject entities:** Access Health CT; Connecticut
- **Predicate:** considering_extending
- **Object:** open enrollment deadline beyond Jan. 31 (policy_action)
- **Temporal:** 2026-01-08
- **Sources:** src_001

> Access Health CT is in discussions with carriers about potentially extending the open enrollment deadline beyond Jan. 31 by one or two months.

### c_002
- **Hedge:** confirmed
- **Corroboration:** primary_document
- **Subject entities:** ACA premium subsidies; Connecticut
- **Predicate:** lapsed
- **Object:** end of 2025 (date)
- **Temporal:** 2025-12-31
- **Sources:** src_001

> Enhanced ACA premium subsidies lapsed at the end of 2025, causing premiums to spike for many Connecticut residents.
...
- **Subject entities:** Access Health CT; Connecticut
- **Predicate:** enrolled
- **Object:** approximately 150,000 (enrollment_count)
- **Temporal:** 2026-01-02
- **Sources:** src_001

> As of Jan. 2, roughly 150,000 Connecticut residents had enrolled in 2026 ACA plans, about 3 to 5 percent higher than the same period last year.

### c_004
- **Hedge:** confirmed
- **Corroboration:** single_source
- **Subject entities:** Connecticut; Ned Lamont
- **Predicate:** committed
- **Object:** $70 million (fiscal_commitment)
- **Temporal:** 2026-01-08
- **Sources:** src_001

> Connecticut committed $70 million in state relief for 2026 from a $500 million emergency response fund to offset the federal subsidy lapse.

### c_005
- **Hedge:** attributed
- **Corroboration:** single_source
- **Subject entities:** Connecticut
- **Predicate:** allocating
- **Object:** nearly $51 million for 100%–200% FPL residents (fiscal_allocation)
- **Temporal:** 2026-01-08
- **Sources:** src_001

> Nearly $51 million of the state fund will fully replace the federal subsidy for residents earning between 100% and 200% of the Federal Poverty Level.

### c_006
- **Hedge:** attributed
- **Corroboration:** single_source
- **Subject entities:** Connecticut
- **Predicate:** covering_partial
- **Object:** half of assistance for 400%–500% FPL residents (fiscal_commitment)
- **Temporal:** 2026-01-08
- **Sources:** src_001

> Connecticut will cover half of the current financial assistance for residents earning between 400% and 500% of the Federal Poverty Level.

### c_007
- **Hedge:** attributed
- **Corroboration:** single_source
- **Subject entities:** Malaine Trecoske; Connecticut
- **Predicate:** faces_annual_premium
- **Object:** $42,000 annually without subsidies; ~$21,000 with state relief (dollar_amount)
- **Temporal:** 2026-01-08
- **Sources:** src_001

> Malaine Trecoske, 64, of Branford would need to pay $42,000 a year to remain on her silver plan without enhanced subsidies; state relief could reduce that to roughly $21,000.

### c_008
- **Hedge:** attributed
- **Corroboration:** single_source
- **Subject entities:** Stephanie Saujon
- **Predicate:** faces_premium_increase
- **Object:** $1,000 per month (dollar_amount)
- **Temporal:** 2026-01-08
- **Sources:** src_001

> Stephanie Saujon, a self-employed photographer in Stratford, faces an increase of about $1,000 a month in health care premiums and does not qualify for state relief.

### c_009
- **Hedge:** confirmed
- **Corroboration:** single_source
- **Subject entities:** U.S. House of Representatives
- **Predicate:** forced_vote
- **Object:** 218 signatures on discharge petition (vote_tally)
- **Temporal:** 2026-01-07
- **Sources:** src_001

> All House Democrats plus four Republicans — 218 total — signed a discharge petition forcing a House floor vote on a three-year ACA subsidy extension.
...
- **Predicate:** blocked
- **Object:** three-year ACA subsidy extension (legislative_action)
- **Temporal:** 2025-12
- **Sources:** src_001

> The Senate blocked a three-year ACA subsidy extension in a key vote last month and is unlikely to take up the House measure.
...
- **Object:** would not bring the bill to a vote (statement)
- **Temporal:** 2026-01-08
- **Sources:** src_001

> House Speaker Mike Johnson said he would not take up the ACA subsidy extension bill.
...
- **Object:** two-year extension with income caps (legislative_proposal)
- **Temporal:** 2026-01-08
- **Sources:** src_001

> A potential Senate compromise would extend the ACA tax credits for two years and impose income caps, according to Politico.

### c_013
- **Hedge:** confirmed
- **Corroboration:** single_source
- **Subject entities:** Connecticut; CoveredCT
- **Predicate:** maintaining
- **Object:** CoveredCT through June 2027 (program_continuation)
- **Temporal:** 2026-01-08
- **Sources:** src_001

> Connecticut's state plan will maintain CoveredCT — the no-cost program for low-income families earning slightly too much for Medicaid — through June 2027.

## Sources

### src_001 — Associated Press, wire, Tier 1, originating
**Author:** Lisa Hagen / The Connecticut Mirror
**Publication date:** 2026-01-08
**Title:** Connecticut weighs extending open enrollment due to uncertainty with federal health care subsidies
**URL:** https://apnews.com/article/ned-lamont-connecticut-james-michel-subsidies-rosa-delauro-2c496127643e3314126c1d8dcc5eebd1
