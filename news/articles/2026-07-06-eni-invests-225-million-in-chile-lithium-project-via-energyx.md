---
headline: Eni invests $225 million in Chile lithium project via EnergyX
secondary_headline: Eni gains technical role, board seat in Chile lithium venture
publish_date: '2026-07-06'
lede: Italian energy company Eni has acquired a 25% stake in the Black Giant lithium project in northern Chile from U.S. startup Energy Exploration Technologies for $225 million, giving Eni rights to up to a quarter of future production and a seat on the project's board of directors, according to a report by The Wall Street Journal published Monday. The investment secures a supply of lithium carbonate for Eni's planned battery plant in southern Italy as global demand for the critical mineral is forecast to rise sharply.
nut_graf: The deal marks the latest move by an Italian energy company into the lithium industry, where traditional energy producers see a natural fit because lithium extraction from underground brines uses techniques similar to oil and gas drilling. Eni's entry provides project-financing certainty for EnergyX's Black Giant development, which faces a permitting process but expects its first phase of 7,500 tons of lithium carbonate to enter production in 2028, with full capacity of 52,500 tons targeted for 2030.
primary_entities:
- Eni
- EnergyX
- Black Giant
...
generation_timestamp: '2026-07-06T04:09:11-07:00'
source_cluster_id: cluster_wsj_2026-07-06_sts-225-million-in-u-s-startup-energyxs-
gdelt_event_ids: []
...
- slug: 2026-07-03-lg-honda-joint-venture-begins-ess-battery-production-at-ohio-plant
  relation: related
  confidence: medium
- slug: 2026-07-01-national-grid-invests-1-75-billion-for-35-stake-in-joulent
  relation: related
  confidence: medium
draft: false
related_stories: []
...
- Italian energy company Eni has bought a 25% stake in EnergyX's Black Giant lithium project in northern Chile for $225 million.
- The project in Chile's Antofagasta region is designed to produce up to 52,500 metric tons of lithium carbonate annually once its first two stages are complete in 2030.
- Eni will play a significant technical and operational role in the project, including well development, brine production, and processing.
- EnergyX founder Teague Egan described the investment as "the defining moment" for his startup, which also has a letter of interest from the U.S. Export-Import Bank for $690 million in project finance support.
