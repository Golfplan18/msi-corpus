...
secondary_headline: Truck division surprises with stronger-than-expected orders
publish_date: '2026-07-17'
lede: Volvo Car's second-quarter adjusted operating profit fell well short of analyst
  expectations, prompting multiple investment banks to project downward forecast revisions,
  according to research notes published Wednesday. The Swedish automaker's results
  contrasted with better-than-expected performance at its truck division and mixed
  signals across the broader auto and transport sector.
nut_graf: The divergent results at Volvo's two main divisions underscore how cyclical
  recovery in commercial vehicles is offsetting persistent weakness in the passenger-car
  market, particularly in China, where pricing pressure and inventory discounts continue
  to weigh on margins.
primary_entities:
- Volvo Car
- Volvo AB
...
generation_timestamp: '2026-07-17T10:08:59-07:00'
source_cluster_id: cluster_wsj_2026-07-17_business-auto-transport-roundup-market-t
gdelt_event_ids: []
...
- slug: 2026-06-17-european-auto-shares-fall-after-bmw-slashes-guidance
  ...
  strength: 0.6791
---
## Volvo Car reports wide second-quarter earnings miss

**Subtype:** fact

- Volvo Car's second-quarter adjusted operating profit fell 36% below analyst consensus, with the EBIT margin of 1.1% coming in well below the expected range, according to SB1 Markets.
- SB1 Markets analyst Edvin Jabeskog projected the results would lead to 4%-6% reductions in market profit forecasts for Volvo Car.
- SEB analysts said the quarter appeared to mark a bottom, with Volvo Car signaling improvement in the second half of the year and gradual cash-flow recovery.
- Volvo AB's truck division reported better-than-expected orders, with RBC Capital Markets citing cyclical recovery across trucks and construction equipment.
- Autoliv reported second-quarter results broadly in line with expectations, though shares fell 4.4% in what SB1 Markets called an excessive reaction.
- Citi analysts said Ryanair's valuation gap with European peers had widened, making a case for the stock to recover recent weakness.
...
**URL:** https://www.wsj.com/business/auto-transport-roundup-market-talk-956efe24
