...
secondary_headline: Rogers Communications buys MLSE stake for C$4.35 billion
publish_date: '2026-07-07'
lede: A roundup of analyst notes Tuesday highlighted Huawei's first 5G smartphone
  launch abroad since U.S. sanctions, Tencent's latest AI model release, and Microsoft's
  plans to cut more than 3,000 jobs in its Xbox division as investors assessed technology
  spending trends.
nut_graf: The roundup covered analyst assessments of Huawei's international smartphone
  launch, Tencent's AI model release, Microsoft's Xbox job cuts, and Rogers Communications'
...
generation_timestamp: '2026-07-07T05:26:42-07:00'
source_cluster_id: cluster_wsj_2026-07-07_business-tech-media-telecom-roundup-mark
gdelt_event_ids: []
...
- slug: 2026-06-09-apple-unveils-ai-revamp-tencent-positions-weixin-as-ai-gateway
  ...
  strength: 0.6612
  confidence: medium
- slug: 2026-06-22-ta-securities-downgrades-malaysia-auto-sector-as-sales-slow
  relation: related
  strength: 0.587
  confidence: medium
...
- slug: 2026-06-09-apple-unveils-ai-revamp-tencent-positions-weixin-as-ai-gateway
  ...
  strength: 0.6964
---
## Huawei, Tencent, Microsoft lead tech roundup as analyst notes

**Subtype:** fact

- Huawei plans to launch the Pura 90 series in Malaysia next week, marking its first 5G-equivalent smartphone in overseas markets since U.S. sanctions cut off global chip supply, said Counterpoint Research senior analyst Ivan Lam.
- Tencent's latest Hy3 AI model, while not frontier-level, provides the capabilities to build agentic services across its ecosystem, Bernstein analysts said in a note; Tencent shares were last 2.7% higher at HK$464.20.
- Microsoft is set to cut more than 3,000 jobs in its Xbox videogames division, but the move did not ease investor concerns about the company's AI-related capital spending, said AJ Bell's Danni Hewson; shares fell 1.5% to $384.74.
- Rogers Communications agreed to buy Larry Tanenbaum's Kilmer Sports' stake in Maple Leafs Sports & Entertainment for C$4.35 billion, implying a C$17.4 billion valuation for MLSE, National Bank of Canada's Adam Shine said.
...
**URL:** https://www.wsj.com/business/tech-media-telecom-roundup-market-talk-b7b090a2
