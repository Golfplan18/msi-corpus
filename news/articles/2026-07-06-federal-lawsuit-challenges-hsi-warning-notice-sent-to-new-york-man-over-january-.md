...
secondary_headline: Lawsuit says warning notices systemically chill protected speech
publish_date: '2026-07-06'
lede: A Rochester, N.Y., man filed a federal lawsuit Monday arguing that his First
  Amendment rights were violated when Homeland Security Investigations agents tracked
  him to his home and later to a hotel in response to an email he sent in January
  harshly criticizing the former acting head of U.S. Immigration and Customs Enforcement.
  The lawsuit, filed by the Foundation for Individual Rights and Expression in Washington,
  D.C., alleges that the Department of Homeland Security is retaliating against critics
  of its officers.
nut_graf: The case is the latest instance of DHS agents contacting people over their
  online communications, raising questions about the scope of protected political
  speech and the authority of federal law enforcement to investigate and warn speakers
  about potential legal violations months after the fact.
primary_entities:
- David Streever
- Todd Lyons
...
generation_timestamp: '2026-07-06T09:05:50-07:00'
source_cluster_id: cluster_npr_2026-07-06_nx-s1-5883784-dhs-ice-critic-lawsuit-free-speech
gdelt_event_ids: []
...
- slug: 2026-02-05-homeland-security-shutdown-more-likely-as-gop-rebuffs-democratic-demands
  relation: related
  confidence: medium
- slug: 2026-02-12-court-filing-says-irs-mistakenly-shared-taxpayer-data-with-dhs
  relation: related
  confidence: medium
draft: false
related_stories:
...
- slug: 2026-02-14-4-indicted-in-minneapolis-clashes-including-woman-accused-of-biting-finger
  ...
  strength: 0.657
---
## Federal lawsuit challenges HSI warning notice sent to New York man over January email to ICE official

- David Streever sued the Department of Homeland Security on July 6 after federal agents tracked him down for a January email he sent to the former acting head of ICE, Todd Lyons.
- The Foundation for Individual Rights and Expression filed the suit in federal court in Washington, D.C., arguing the email was protected speech and that the agents' actions violated Streever's First Amendment rights.
- Two Homeland Security Investigations agents visited Streever's Rochester home on June 23 and left a warning notice saying his email may have violated federal law prohibiting threats against federal officials.
- That same day, agents also confronted Syracuse resident Paigelynne Gonyea at her polling place about an Instagram post, according to the lawsuit and reporting from NPR and other outlets.
- FIRE attorney Adam Steinbaugh said the five-month gap between Streever's email and the agents' visit undermines the claim that it involved a genuine threat.
...
**URL:** https://www.npr.org/2026/07/06/nx-s1-5883784/dhs-ice-critic-lawsuit-free-speech
