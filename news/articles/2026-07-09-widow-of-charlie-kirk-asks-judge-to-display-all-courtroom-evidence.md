...
secondary_headline: Defense challenges video, DNA evidence handling in Kirk hearing
publish_date: '2026-07-09'
lede: Erika Kirk, the widow of slain conservative activist Charlie Kirk, has asked
  a Utah judge to require that every exhibit introduced during the preliminary hearing
  for the man accused of killing him be displayed openly in the courtroom, saying
  the lack of transparency fuels conspiracy theories.
nut_graf: The request, filed Wednesday, puts the family's request for visibility at
  the center of a hearing already marked by disputes over video evidence, DNA testing,
  and a contested recording that prosecutors say contains a confession.
primary_entities:
- Erika Kirk
- Charlie Kirk
- Tyler Robinson
...
generation_timestamp: '2026-07-09T10:19:22-07:00'
source_cluster_id: cluster_guardian_2026-07-09_us-news-2026-jul-09-erika-charlie-kirk-t
gdelt_event_ids: []
...
- slug: 2026-06-22-judge-denies-witness-subpoena-in-charlie-kirk-murder-case
  ...
  strength: 0.6839
---
## Widow of Charlie Kirk asks judge to display all courtroom evidence

**Subtype:** fact

- Erika Kirk filed a motion in Utah County District Court on Wednesday asking that all evidence in the preliminary hearing of Tyler Robinson be displayed openly in the courtroom.
- Kirk's attorney, Jeffrey Neiman, told the court that denying visual access to evidence violates the family's rights as crime victims and allows conspiracy theories about the killing to spread.
- The preliminary hearing has featured surveillance video and testimony, but defense attorneys have objected to modifications made to the video and raised issues with the chain of custody of physical evidence.
- A recorded interview with Robinson's roommate, Lance Twiggs, is also contested, with defense attorneys arguing that prosecutors intend to use it in a manner the defense argues would violate the defendant's right to a fair trial.
...
**Title:** Erika Kirk asks for all exhibits linked to husband’s killing to be made public
