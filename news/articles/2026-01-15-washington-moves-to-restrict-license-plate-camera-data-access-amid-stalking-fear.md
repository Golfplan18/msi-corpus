...
lede: 'Washington state lawmakers have introduced legislation to sharply limit public access to automatic license-plate reader data after a November court ruling found that nearly all images captured by the cameras in the state qualify as public records available to anyone who requests them — a decision that law enforcement officials say could allow stalkers and abusers to track victims through government databases.
