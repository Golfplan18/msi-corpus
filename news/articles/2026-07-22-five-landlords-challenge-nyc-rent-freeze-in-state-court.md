...
secondary_headline: Lawsuit alleges process was a sham orchestrated by mayor
publish_date: '2026-07-22'
lede: A group of five small landlords filed a lawsuit Wednesday in New York state
  court seeking to overturn the rent freeze approved by the New York City Rent Guidelines
  Board last month, accusing the board of conducting a “sham process” influenced by
  Mayor Zohran Mamdani. The lawsuit is the first legal challenge to the 0% rent increase
  on one- and two-year leases for roughly one million rent-stabilized apartments,
  a signature campaign promise of the Democratic socialist mayor.
nut_graf: The legal challenge signals growing pushback from the real-estate industry
  against Mamdani's housing affordability agenda, which also includes a 23-point plan
  to take legal action against negligent landlords. Landlords argue that the freeze,
  combined with high interest rates, rising utility costs, and a 2019 law tightening
  rent regulations, threatens their ability to maintain properties.
primary_entities:
- New York City
...
- rent regulation
- legal challenges to mayoral policy
topic_tags:
...
generation_timestamp: '2026-07-22T08:10:18-07:00'
source_cluster_id: cluster_wsj_2026-07-22_real-estate-new-york-city-rent-freeze-la
gdelt_event_ids: []
...
- Five small landlords filed a lawsuit Wednesday challenging the New York City Rent Guidelines Board's vote in June to freeze rents on roughly one million rent-stabilized apartments, alleging the process was a "sham" influenced by Mayor Zohran Mamdani.
- The lawsuit, filed in state court, argues that Mamdani stacked the board with loyalists and manipulated data on landlord expenses and income to produce the 7-1 vote for zero rent increases.
- Randy Mastro, a lawyer for the plaintiffs and former deputy mayor, said the mayor went to "extraordinary lengths" to guarantee the freeze, calling it "a perversion of the process."
- The lawsuit cited the resignation of a board member representing landlords, who said the board had ceased to be a fact-finding body and intended to freeze rents regardless of evidence.
- Median renter income in New York City rose 1.8% in 2024 while metro-area rent inflation hit 4.7%, according to census data, as Manhattan apartments rented for a median $5,295 a month.
