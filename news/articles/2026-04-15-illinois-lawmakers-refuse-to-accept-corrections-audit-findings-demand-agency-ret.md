...
lede: 'Illinois''s Legislative Audit Commission refused Tuesday to accept a state Department of Corrections audit that found 40 failures — including a decade-old overtime scheme that cost the state $150 million in fiscal year 2024 — and ordered the agency to return with answers on its remediation progress.
