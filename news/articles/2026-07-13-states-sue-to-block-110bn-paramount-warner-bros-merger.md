...
secondary_headline: DOJ approved deal in June; Paramount calls suit "fundamentally
  flawed"
publish_date: '2026-07-13'
lede: A coalition of twelve state attorneys general, led by California, filed suit
  Monday seeking to block the $110 billion merger between Paramount and Warner Bros.,
  arguing the deal would concentrate Hollywood power and harm consumers through higher
  prices and reduced content. The challenge comes one month after the US Department
  of Justice approved the combination. The plaintiffs describe the transaction as
  the largest media consolidation in Hollywood history.
nut_graf: The lawsuit puts the transaction in direct conflict with state-level antitrust
  enforcement and tests whether attorneys general can halt a combination the federal
  government has already cleared.
primary_entities:
- Rob Bonta
- Letitia James
...
generation_timestamp: '2026-07-13T12:06:25-07:00'
source_cluster_id: cluster_bbc_2026-07-13_news-articles-cgev34lvgp4o
gdelt_event_ids: []
...
- slug: 2026-04-24-warner-bros-shareholders-approve-paramount-s-81-billion-takeover
  ...
  strength: 0.7963
- slug: 2026-04-23-hbo-max-and-paramount-on-1-platform-what-a-warner-paramount-deal-could-mean
  headline: 'HBO Max and Paramount+ on 1 platform: What a Warner-Paramount deal could
    mean'
...
- California Attorney General Rob Bonta led a coalition of 12 state attorneys general in filing suit Monday to block the $110 billion Paramount-Warner Bros merger on antitrust grounds.
- The lawsuit targets the deal's impact on major cinema releases, blockbusters, and basic cable TV channels, and argues the combined company would control nearly a third of the US theatrical motion picture market.
- The challenge comes one month after the Justice Department approved the merger; Warner Bros shareholders approved the deal in April at $31 per share.
- The lawsuit argues that four conglomerates — the merged entity, Disney, Universal, and Sony — would control 86% of major film releases.
- New York Attorney General Letitia James joined the suit, calling the merger "unprecedented power and influence over news and entertainment across the globe."
- Paramount characterized the lawsuit as "fundamentally flawed" and "wrong," pledging to "vigorously defend the transaction."
...
**URL:** https://www.bbc.co.uk/news/articles/cgev34lvgp4o

### src_002 — United Press International, wire, Tier 2, originating
**Publication date:** 2026-07-13
**Title:** 12 states sue to block planned Paramount, Warner Bros. merger
**URL:** https://www.upi.com/Top_News/US/2026/07/13/paramount-warner-bros-lawsuit-merger/7081783960258/
