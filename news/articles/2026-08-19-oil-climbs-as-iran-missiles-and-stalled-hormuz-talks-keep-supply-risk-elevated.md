...
secondary_headline: UAE halts Iran trade as Trump confirms blockade remains in force
publish_date: '2026-08-19'
lede: Oil prices rose for a fourth consecutive session on Tuesday, with Brent crude
  trading above $91 a barrel as talks to reopen the Strait of Hormuz stalled and after
  Iran fired two ballistic missiles toward the strait and struck a bulk carrier. In
  early European trading, Brent gained 0.2% to $91.26 a barrel, while West Texas Intermediate
  futures rose 0.3% to $84.37 a barrel, according to The Wall Street Journal.
nut_graf: The price gains reflect a sustained risk premium tied to six months of U.S.-Iran
  conflict and an ongoing naval blockade of the strait, with Iranian missile strikes
  and the stalled diplomatic talks keeping supply disruptions in play.
primary_entities:
- Oil
- Strait of Hormuz
- Iran
...
generation_timestamp: '2026-08-19T01:06:41-07:00'
source_cluster_id: cluster_wsj_2026-08-19_tures-oil-rises-amid-growing-concerns-ov
gdelt_event_ids: []
...
- Oil prices rose for a fourth consecutive session, with Brent crude at $91.26 a barrel and West Texas Intermediate at $84.37, as talks to reopen the Strait of Hormuz stalled.
- Iran fired two ballistic missiles toward the Strait of Hormuz on Tuesday, triggering UAE air defenses, and struck the engine room of a bulk carrier east of Oman.
- President Trump said there are no ongoing or scheduled talks with Tehran and confirmed the U.S. naval blockade remains in full force.
- The UAE halted trade and financial transactions with Iran following the Iranian missile attacks and the bulk carrier strike.
...
**Title:** Oil Rises on Persistent Hormuz Uncertainty
