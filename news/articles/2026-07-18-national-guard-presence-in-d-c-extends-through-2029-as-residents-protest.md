---
headline: National Guard presence in D.C. extends through 2029 as residents protest
secondary_headline: Niskanen Center study finds no effect on violent crime
publish_date: '2026-07-18'
lede: Nearly a year after President Donald Trump deployed thousands of National Guard
  troops to Washington, D.C., under a crime emergency declaration, the order was extended
  through January 2029, prolonging a military presence that residents describe as
  a "military occupation."
nut_graf: For roughly 10 months, between 2,000 and 2,500 troops have patrolled metro
  stations, parks, and city streets. In July, that number doubled to more than 5,000
  as part of a "summer surge" around the nation's 250th birthday celebration. District
  officials lack authority to withdraw the troops because Washington is not a state.
primary_entities:
- Washington, D.C.
- National Guard
- Donald Trump
...
generation_timestamp: '2026-07-18T04:03:52-07:00'
source_cluster_id: cluster_guardian_2026-07-18_us-news-2026-jul-18-washington-dc-nation
gdelt_event_ids: []
...
- slug: 2026-06-21-at-least-seven-killed-in-chicago-shootings-as-trump-renews-military-call
  headline: At least seven killed in Chicago shootings as Trump renews military call
  publish_date: '2026-06-21'
  relation: related
  strength: 0.6876
- slug: 2026-04-20-eight-months-in-washington-s-national-guard-deployment-shows-no-end-in-sight
  headline: Eight months in, Washington's National Guard deployment shows no end in
    sight
...
- slug: 2026-01-16-army-memo-extends-d-c-national-guard-deployment-through-end-of-2026
  ...
  relation: related
  strength: 0.8109
- slug: 2026-03-02-louisiana-national-guard-extends-new-orleans-troop-deployment-through-august
  headline: Louisiana National Guard extends New Orleans troop deployment through
    August
...
- Nearly a year after President Donald Trump deployed National Guard troops to Washington, D.C., under a crime emergency declaration, the order was extended through January 2029.
- An analysis from the nonpartisan Niskanen Center found the deployment had no measurable effect on violent crime, which was already declining, though property crime dropped 24%.
- The deployment costs approximately $1.65 million per day, according to the Niskanen Center.
- The Justice Department reported the broader DC Safe and Beautiful Task Force has made more than 13,900 arrests, removed over 1,500 firearms, and found 23 missing children since August 2025.
