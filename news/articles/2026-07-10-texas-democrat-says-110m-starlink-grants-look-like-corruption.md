...
secondary_headline: Johnson pledges to investigate SpaceX deal if elected attorney
  general
publish_date: '2026-07-10'
lede: Democratic state Sen. Nathan Johnson, the party's nominee for Texas attorney
  general, said Friday that $110 million in state broadband grants awarded to Elon
  Musk's SpaceX for its Starlink satellite-internet program looked like corruption,
  and pledged to investigate the deal if elected in November.
nut_graf: Johnson's comments, made in an interview with the Dallas Morning News, put
  an investigation into Musk's Texas business dealings directly on the November ballot.
  The grants became a source of controversy after testimony revealed that Republican
  Gov. Greg Abbott's office requested changes to the grant-awarding rules that critics
  said favored Starlink over ground-based fiber providers.
primary_entities:
- Nathan Johnson
- Elon Musk
- SpaceX
...
generation_timestamp: '2026-07-10T14:34:18-07:00'
source_cluster_id: cluster_guardian_2026-07-10_-2026-jul-10-democrat-texas-ag-candidate
gdelt_event_ids: []
consensus_floor_version: v0.3.0
publication_mindspec_version: v0.3.0
license: CC0-1.0
ai_disclosure: This article was produced by an AI system operating from published,
  auditable instructions. Every factual claim traces to the source material cited
  in the article's Sources section.
ai_generated: true
sources:
  count: 1
  outlets:
...
- slug: 2026-07-02-spacex-starlink-plans-mobile-service-to-target-at-t-verizon
  relation: related
  confidence: medium
- slug: 2026-06-24-texas-prepares-for-disruptor-as-new-top-voting-official
  relation: related
  confidence: medium
...
draft: false
image:
  url: /articles/2026-07-10-texas-democrat-says-110m-starlink-grants-look-like-corruption.png
  alt: 'Illustration accompanying article: Texas Democrat says $110M Starlink grants
...
related_stories:
- slug: 2026-07-10-110m-in-texas-starlink-grants-sure-looks-like-corruption-democratic-ag-nominee-s
  headline: $110M in Texas Starlink grants 'sure looks like' corruption, Democratic
    AG nominee says
  publish_date: '2026-07-10'
  relation: related
  strength: 0.9776
...
- slug: 2026-05-18-ryanair-ceo-dismisses-musk-s-offer-to-buy-airline-amid-starlink-feud
  ...
  strength: 0.6522
---
## Texas Democrat says $110M Starlink grants look like corruption

**Subtype:** fact

- Democratic state Sen. Nathan Johnson, the party's nominee for Texas attorney general, said $110 million in state broadband grants to SpaceX's Starlink appeared to involve corruption and pledged to investigate if elected.
- Johnson called the awards "lopsided," saying the vast majority of available grant funding went to a single company.
- Testimony at earlier legislative hearings indicated that Republican Gov. Greg Abbott's office had requested changes to the grant-awarding rules that critics said favored Starlink over ground-based fiber providers.
- Johnson's Republican opponent in the November election, state Sen. Mayes Middleton, has declared himself a Trump loyalist.
...
**Title:** Democrat running for Texas AG claims $110m in grants for Starlink ‘sure looks’ like corruption
