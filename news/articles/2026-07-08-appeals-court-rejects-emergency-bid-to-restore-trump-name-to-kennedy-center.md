...
secondary_headline: Panel faults lack of evidence for fundraising harm claims
publish_date: '2026-07-08'
lede: A federal appeals court on Wednesday denied the Trump administration's emergency
  request to restore President Donald Trump's name to the facade of the John F. Kennedy
  Center for the Performing Arts while the legal challenge over the venue's name continues.
  The unsigned order from a three-judge panel of the U.S. Court of Appeals for the
  District of Columbia Circuit rejected arguments that removing Trump's name would
  harm fundraising efforts, saying the administration failed to provide specific facts
  or evidence to support that claim.
nut_graf: The ruling means Trump's name will remain off the Kennedy Center's facade
  — stripped in June under a lower court order — while the underlying lawsuit over
  whether the president had legal authority to rename the congressionally designated
  venue proceeds on appeal. The panel's decision was not a ruling on the merits of
  the case.
primary_entities:
- Donald Trump
- Kennedy Center
...
generation_timestamp: '2026-07-08T10:18:58-07:00'
source_cluster_id: cluster_guardian_2026-07-08_us-news-2026-jul-08-trump-name-kennedy-c
gdelt_event_ids: []
...
- slug: 2026-06-14-trump-administration-tells-court-white-house-ballroom-is-too-far-along-to-stop
  ...
  strength: 0.6643
---
## Appeals court rejects emergency bid to restore Trump name to Kennedy Center

**Subtype:** fact

- The U.S. Court of Appeals for the District of Columbia Circuit on Wednesday denied the Trump administration's emergency request to restore President Donald Trump's name to the Kennedy Center facade during the appeal of a lower court order mandating its removal.
- The three-judge panel said the administration had not backed its claim that removal would harm fundraising "with any specific facts or evidence" and noted that since the name had already been removed, a stay would not prevent the alleged harms.
- The panel also rejected the administration's argument that a new entity called the Trump Kennedy Center for the Performing Arts Foundation would have to return money if Trump's name is not restored to the facade.
- The ruling is not a decision on the merits; Trump's underlying appeal of U.S. District Judge Christopher Cooper's order can continue.
...
**Title:** US court says Trump name must stay off Kennedy Center during appeal
**URL:** https://www.theguardian.com/us-news/2026/jul/08/trump-name-kennedy-center-ruling
