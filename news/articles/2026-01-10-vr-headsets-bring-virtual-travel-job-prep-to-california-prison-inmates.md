...
nut_graf: The nonprofit runs the program three times a year at four California prisons, using 100 Oculus headsets donated by Meta. Researchers say VR technology could play a meaningful role in rehabilitation and reentry preparation, though cost and equitable access remain concerns.
primary_entities:
- Creative Acts
- Sabra Williams
- Jacob Smith
...
figures_aggregate:
  ...
  sources: []
image:
  url: /articles/2026-01-10-vr-headsets-bring-virtual-travel-job-prep-to-california-prison-inmates.png
  alt: 'Illustration accompanying article: VR headsets bring virtual travel, job prep to California prison inmates'
  source: ai_generated
cross_article_links: []
draft: false
---
