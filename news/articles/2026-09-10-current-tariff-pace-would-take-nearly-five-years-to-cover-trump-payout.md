...
generation_timestamp: '2026-09-10T15:00:00Z'
source_cluster_id: cluster_guardian_2026-09-10_us-news-2026-sep-10-trump-5000-midterm-c
gdelt_event_ids: []
...
- Bipartisan Policy Center data show that the United States collected about $210 billion in tariff and excise tax revenue in 2026 through September 8.
- The current monthly revenue pace would need to continue for nearly five years to cover Donald Trump’s proposed $5,000 payment under assumptions that every dollar went to the payout and refunded tariffs were excluded.
- Marc Goldwein of the Committee for a Responsible Federal Budget estimated that the proposal would cost about $1.2 trillion in one year.
- Peter Schiff of Euro Pacific Asset Management said bond investors were selling Treasuries and sending yields higher in response to the pledge.
- Republican US Rep. Chip Roy questioned the financing, while US Sen. Bernie Moreno promised to have a bill ready so the dividend could pass immediately after the November 3 election.
...
**Title:** Trump’s promise of $5,000 ‘dividend’ for US citizens after midterms met with incredulity
