...
secondary_headline: Proposal would refund bond only after citizenship
publish_date: '2026-07-15'
lede: The Trump administration is considering requiring some green-card seekers applying
  at U.S. consulates abroad to post a bond of roughly $100,000, according to people
  familiar with the plans. The State Department is developing the proposal as part
  of ongoing efforts to limit immigration by foreigners of limited means, with applicants
  likely receiving the money back only after becoming U.S. citizens.
nut_graf: The bond proposal would expand a tool the administration has been testing
  on tourist visas since last August and represents the latest step in ongoing efforts
  to limit immigration by imposing financial requirements that immigration advocates
  say put permanent residence out of reach for all but the wealthy.
primary_entities:
- United States
- State Department
- Tommy Pigott
...
generation_timestamp: '2026-07-15T17:18:25-07:00'
