...
headline: 93% of cancer disparities researchers affected by federal funding changes,
  report finds
secondary_headline: Survey of 122 scientists reveals halted trials, layoffs, and uncertainty
publish_date: '2026-07-15'
lede: About 93% of cancer disparities researchers reported that federal policy changes
  have disrupted their work, according to a new report from the American Association
  for Cancer Research, as grant cancellations and freezes continue to reshape the
  scientific landscape.
nut_graf: The survey, which included 122 professors, scientists and students, found
  that 78% have been unable to apply for funding and 59% said ongoing projects were
  disrupted, with respondents pointing to the National Institutes of Health as the
  primary source of lost funding. The findings illustrate how executive orders and
  funding changes aimed at ending DEI-related research have affected a field that
  researchers say has driven measurable progress in narrowing cancer outcome gaps.
primary_entities:
...
generation_timestamp: '2026-07-15T10:29:56-07:00'
source_cluster_id: cluster_npr_2026-07-15_nx-s1-5893653-cancer-disparities-gaps-research-fun
gdelt_event_ids: []
...
- slug: 2026-06-07-how-u-s-aid-cuts-are-reshaping-hiv-aids-efforts-in-africa
  relation: related
  confidence: medium
- slug: 2026-05-17-colon-cancer-deaths-among-young-adults-linked-to-education-gap
  relation: related
  confidence: medium
- slug: 2026-05-16-conflicting-advice-makes-it-hard-to-know-when-to-get-a-mammogram
  relation: related
  confidence: medium
- slug: 2026-05-16-breast-cancer-screening-guidelines-conflict-as-new-advice-recommends-starting-at
  relation: related
  confidence: medium
- slug: 2026-04-04-trump-s-50b-rural-health-fund-offers-ailing-hospitals-few-solutions
  relation: related
  confidence: medium
- slug: 2026-02-05-study-links-covid-19-disruptions-to-worse-short-term-cancer-survival
  relation: related
  confidence: medium
- slug: 2026-02-12-cancer-diagnoses-rise-in-adults-under-50-study-finds-increases-in-breast-colon
  relation: related
  confidence: medium
- slug: 2026-03-21-poll-finds-aca-enrollees-cutting-food-and-skipping-care-as-subsidies-end
  relation: related
  confidence: medium
- slug: 2026-02-19-us-prenatal-care-declines-especially-for-black-mothers
  relation: related
  confidence: medium
...
- slug: 2026-05-21-researchers-say-trump-administration-is-finding-new-ways-to-punish-science
  ...
  strength: 0.72
---
## 93% of cancer disparities researchers affected by federal funding changes, report finds

**Subtype:** fact

- The AACR report found 93% of surveyed cancer disparities researchers reported that federal policy changes have affected their work.
- Seventy-eight percent of the 122 respondents said they have been unable to apply for funding, and 59% said ongoing research projects were disrupted.
- In the first half of 2025, the National Cancer Institute canceled 181 grants totaling more than $317 million, many studying disparities.
- Heather Pierce of the Association of American Medical Colleges described the funding cancellations as a "mass termination" of unprecedented scale.
- Researchers reported halted clinical trials, layoffs, and a shift away from minority-focused programs in response to executive orders targeting DEI initiatives.
...
**URL:** https://www.npr.org/2026/07/15/nx-s1-5893653/cancer-disparities-gaps-research-funding-grant-disruptions
