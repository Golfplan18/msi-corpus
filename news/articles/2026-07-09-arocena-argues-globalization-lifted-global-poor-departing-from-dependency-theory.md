---
headline: Arocena argues globalization lifted global poor, departing from dependency
  theory
secondary_headline: CSIS tabletop exercise found Russia, China pursue distinct playbooks
  in region
publish_date: '2026-07-09'
lede: Uruguayan writer Juan Pedro Arocena, in a UPI analysis published Thursday, argued
  that Latin America's political vocabulary — shaped by 20th-century theories of imperialism
  and dependency — has left the region unprepared to navigate a multipolar era in
  which Washington, Moscow and Beijing pursue distinct and sometimes conflicting strategies
  in the same hemisphere.
nut_graf: The analysis, citing a spring 2026 Center for Strategic and International
  Studies tabletop exercise on a hypothetical Venezuela crisis, contended that the
  region's inherited intellectual frameworks cannot adequately describe a world in
  which multiple great powers compete for influence without reducing all economic
  exchange to a form of conquest.
primary_entities:
- Latin America
- United States
- Russia
...
generation_timestamp: '2026-07-09T12:04:11-07:00'
source_cluster_id: cluster_upi_2026-07-09_m-perspectives-latrin-america-new-vocabu
gdelt_event_ids: []
...
- Uruguayan writer Juan Pedro Arocena, writing in UPI, argued that Latin America's inherited political vocabulary — rooted in Leninist theories of imperialism and Dependency Theory — cannot adequately describe the current multipolar era.
- A spring 2026 CSIS tabletop exercise based on a hypothetical Venezuela crisis found that Russia and China pursue "very different playbooks" in Latin America, even when their interests overlap, according to the analysis.
- Arocena cited World Bank estimates showing less than 9% of the world's population lived in extreme poverty in 2019, arguing those gains came from commerce and the gradual integration of more people into the global economy rather than from colonial conquest.
- Russia's full-scale invasion of Ukraine in 2022, following its 2014 annexation of Crimea, demonstrated an older form of imperial ambition that trade alone cannot restrain, the analysis stated.
