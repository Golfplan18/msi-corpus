...
headline: Brent crude tops $100 a barrel as Red Sea attacks threaten Saudi export
  route
secondary_headline: UK petrol at £1.56 a litre, US gasoline passes $4 a gallon as
  crude rallies
publish_date: '2026-07-23'
lede: Oil prices rose above $100 a barrel Thursday for the first time since May, the
  BBC reported, as escalating conflict in the Middle East stoked concerns about global
  energy supplies. Brent crude, the global benchmark, rose more than 6% on the day.
  The BBC reported the surge followed an attack by Houthi militia in Yemen on oil
  tankers in the Red Sea, threatening a key export route Saudi Arabia has used to
  bypass the Strait of Hormuz.
nut_graf: The renewed price surge threatens to push up inflation for consumers in
  the UK and the US, where the cost of living had begun to ease, and could complicate
  the outlook for interest rates as central banks weigh whether to hold borrowing
  costs steady or raise them further.
primary_entities:
- Brent crude
- Houthi militants
- Red Sea
...
generation_timestamp: '2026-07-23T11:33:08-07:00'
source_cluster_id: cluster_bbc_2026-07-23_news-articles-cx2djnzrqk2o
gdelt_event_ids: []
...
- slug: 2026-03-13-oil-jumps-to-100-per-barrel-and-stocks-sink-worldwide-on-iran-war
  ...
  strength: 0.7658
  confidence: medium
- slug: 2026-03-01-oil-prices-jump-more-than-6-as-u-s-stocks-erase-early-losses-over-iran-war
  relation: related
  strength: 0.7684
  confidence: medium
draft: false
...
- Brent crude rose above $100 a barrel Thursday for the first time since May, rising more than 6% as the US stepped up military strikes on Iran.
- The price surge followed an attack by Houthi militia in Yemen on oil tankers in the Red Sea, threatening a Saudi bypass route around the Strait of Hormuz.
- UK petrol prices have risen 5p a litre since July 1 to nearly £1.56, and US gasoline surpassed $4 a gallon, up from $3.92 a month ago, according to the RAC and AAA.
- The Bank of England held its rate at 3.75% for a fourth meeting, and the US Federal Reserve held rates between 3.5% and 3.75% as Chair Kevin Warsh told Congress the bank had "no tolerance to persistently elevated inflation."
- US Secretary of State Marco Rubio said this week that Iranian leaders were "not ready to make a deal," dimming prospects for a diplomatic resolution.
