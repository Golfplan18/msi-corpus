...
lede: The U.S. Education Department said Thursday it will no longer consider school
  policies that disproportionately harm one group of students as discriminatory unless
  the discrimination is intentional, rescinding a decades-long standard for civil
  rights enforcement.
nut_graf: The rule change removes disparate impact provisions from regulations that
  implement Title VI of the Civil Rights Act of 1964, which bars discrimination based
  on race or national origin, and shifts the standard for evaluating civil rights
  complaints in schools to require evidence of deliberate intent.
primary_entities:
...
source_cluster_id: cluster_ap_2026-07-23_disparate-impact-discrimination-educatio
gdelt_event_ids: []
...
- The U.S. Education Department said it will no longer consider school policies that disproportionately harm one group of students as discriminatory unless the discrimination is intentional, rescinding a decades-long standard for civil rights enforcement.
- The department said it would remove a number of disparate impact provisions from its regulations related to Title VI, which bars discrimination on the basis of race or national origin.
- The standard has been applied most notably to school discipline policies; data has shown Black students are more likely to receive punishments that remove them from the classroom, such as suspensions, expulsions, and transfers to alternative schools.
- Racial justice advocates have pushed for policies to reduce those disparities, and those efforts have drawn opposition from the Trump administration.
