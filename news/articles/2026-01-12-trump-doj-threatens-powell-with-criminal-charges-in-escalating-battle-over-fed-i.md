---
headline: Trump DOJ threatens Powell with criminal charges in escalating battle over Fed independence
publish_date: '2026-01-12'
lede: 'The Trump administration''s Justice Department threatened Federal Reserve Chair Jerome Powell with criminal indictment over testimony he gave about the central bank''s headquarters renovation, escalating a months-long campaign to exert greater control over the institution and its interest-rate decisions, the Associated Press reported.
...
nut_graf: The confrontation has renewed scrutiny of why central bank independence matters to financial markets and the broader economy, and what federal law actually allows a president to do to influence Fed policy.
primary_entities:
- Jerome Powell
- Federal Reserve
- Donald Trump
...
figures_aggregate:
  ...
  sources: []
image:
  url: /articles/2026-01-12-trump-doj-threatens-powell-with-criminal-charges-in-escalating-battle-over-fed-i.png
  alt: 'Illustration accompanying article: Trump DOJ threatens Powell with criminal charges in escalating battle over'
  source: ai_generated
cross_article_links: []
draft: false
---
