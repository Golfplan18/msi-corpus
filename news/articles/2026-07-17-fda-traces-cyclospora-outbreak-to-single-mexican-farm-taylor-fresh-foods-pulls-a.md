...
secondary_headline: Independent farm represents less than 1% of U.S. iceberg lettuce
  supply, company says
publish_date: '2026-07-17'
lede: Produce supplier Taylor Fresh Foods is voluntarily removing all iceberg lettuce
  sourced from central Mexico from the U.S. market, after the Food and Drug Administration
  traced a Cyclospora outbreak to shredded lettuce produced in the country.
nut_graf: The recall comes as part of a multistate Cyclospora outbreak investigation
  that has spread across more than 30 states, with the FDA linking cases to Taco Bell
  locations in Michigan, Indiana, Ohio, Kentucky and West Virginia and identifying
  a single independent farm as the likely source.
primary_entities:
- Taylor Fresh Foods
- Taylor Farms
...
generation_timestamp: '2026-07-17T12:05:18-07:00'
source_cluster_id: cluster_wsj_2026-07-17_farms-is-recalling-its-mexican-grown-ice
gdelt_event_ids: []
...
- slug: 2026-07-07-michigan-cyclospora-cases-surge-past-670-as-cdc-probes-multistate-outbreak
  ...
  strength: 0.6837
---
## FDA traces Cyclospora outbreak to single Mexican farm; Taylor Fresh Foods pulls all central-Mexico iceberg lettuce

**Subtype:** fact

- Taylor Fresh Foods initiated a voluntary recall of all iceberg lettuce sourced from central Mexico from the U.S. market after the FDA traced a Cyclospora outbreak to shredded lettuce produced in the country.
- More than 1,600 people have been sickened across more than 30 states, with over 90 hospitalizations; the FDA linked the outbreak to Taco Bell locations in Michigan, Indiana, Ohio, Kentucky and West Virginia.
- FDA traceback data indicates a single independent farm — representing less than 1% of the U.S. iceberg lettuce supply — as the potential source; the company said no other products or its branded salad kits are affected.
- Taco Bell had already voluntarily removed potentially affected lettuce in select states Thursday; Yum Brands, Taco Bell's parent company, said the chain acted after federal health officials identified the link.
...
**Title:** Taylor Farms Is Recalling Its Mexican-Grown Iceberg Lettuce From U.S.
**URL:** https://www.wsj.com/business/retail/taylor-farms-is-recalling-its-mexican-grown-iceberg-lettuce-from-u-s-52d2e23f
