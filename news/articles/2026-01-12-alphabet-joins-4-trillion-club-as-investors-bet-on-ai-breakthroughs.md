---
headline: Alphabet joins $4 trillion club as investors bet on AI breakthroughs
publish_date: '2026-01-12'
lede: Google's corporate parent Alphabet Inc. became the fourth major technology company to reach a $4 trillion market valuation on Monday, joining a club that had previously admitted only computer chipmaker Nvidia, Apple, and Microsoft as investors continued to wager heavily on artificial intelligence. The milestone arrived roughly four months after a federal judge found Google's search engine to be an illegal monopoly but declined to impose the breakup remedies federal prosecutors had sought.
nut_graf: Alphabet's ascent to $4 trillion reflects both investor confidence in its AI positioning and the relatively light antitrust remedy that followed the monopoly ruling, with the company's stock rising 57 percent since the decision and adding an estimated $1.4 trillion in shareholder wealth.
primary_entities:
- Alphabet Inc.
- Sundar Pichai
- Amit Mehta
