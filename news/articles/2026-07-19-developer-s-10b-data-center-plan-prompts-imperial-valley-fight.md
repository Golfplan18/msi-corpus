---
headline: Developer's $10B data center plan prompts Imperial Valley fight
secondary_headline: County moratorium, lawsuits, and protests follow proposal
publish_date: '2026-07-19'
lede: In Imperial, a small desert town in California's Imperial Valley, a developer
  with a past including ownership of an Ohio strip club and operation of a drug-treatment
  center that drew a federal probe is pushing to build a 950,000-square-foot data
  center, a $10 billion proposal that has divided the community and prompted lawsuits.
  Sebastian Rucci, a land-use lawyer, said his history makes him well-suited to fight
  the growing opposition to data centers nationwide. The fight has escalated to lawsuits,
  death threats, a county moratorium, and a protest song.
nut_graf: 'The battle over Rucci''s project reflects a national pattern: the surge
  in computing demand driven by artificial intelligence is colliding with local concerns
  about strained infrastructure, environmental impacts, and developer accountability.
  McKinsey & Company estimates the world will spend $7 trillion on data centers by
  2030, drawing entrepreneurs of all backgrounds into the race.'
primary_entities:
- Imperial Valley
- Imperial County Board of Supervisors
- Google
- Sebastian Rucci
- Christopher Scurries
- Steve Padilla
...
generation_timestamp: '2026-07-18T18:06:28-07:00'
source_cluster_id: cluster_wsj_2026-07-18_ip-club-now-he-wants-to-build-california
gdelt_event_ids: []
...
figures_aggregate:
  ...
  sources: []
cross_article_links:
- slug: 2026-07-16-power-companies-use-eminent-domain-to-seize-land-for-data-center-transmission-li
  relation: related
  confidence: medium
...
- slug: 2026-06-14-o-leary-blames-china-for-utah-data-center-opposition
  relation: related
  confidence: medium
- slug: 2026-06-26-armed-police-raid-youtuber-s-airbnb-amid-utah-star-wars-lego-feud
  relation: related
  confidence: medium
...
- slug: 2026-06-01-wisconsin-comedian-charlie-berens-uses-humor-to-fight-ai-data-center-expansion
  relation: related
  confidence: medium
- slug: 2026-06-03-monterey-park-votes-to-permanently-ban-data-centers-a-us-first
  relation: related
  confidence: medium
...
related_stories: []
---
## Developer's $10B data center plan prompts Imperial Valley fight

- Sebastian Rucci, a land-use lawyer whose past includes owning an Ohio strip club and running a drug-treatment center that drew a federal probe, is pushing to build a 950,000-square-foot data center in Imperial, California.
- Imperial County residents led by high-school band director Christopher Scurries pressured the Board of Supervisors, which enacted a one-year moratorium on data center projects.
- Rucci has sued the county, the Imperial Irrigation District, a local activist, and a news station over the project, and called state Sen. Steve Padilla, who proposed regulating data centers, a "buffoon."
- Rucci said he has sunk $5 million of his own money into the project and vowed not to back down, declaring: "Just give me my damn data center."
...
**Title:** He Ran a Strip Club. Now He Wants to Build California’s Biggest Data Center.
**URL:** https://www.wsj.com/us-news/he-ran-a-strip-club-now-he-wants-to-build-californias-biggest-data-center-2135e916
