---
headline: Vance says Trump administration 'absolutely screwed up' Epstein files communications
secondary_headline: Vance says Bondi overstated what Epstein files contained
publish_date: '2026-07-15'
lede: Vice President JD Vance said the Trump administration "absolutely screwed up
  the comms" of the Jeffrey Epstein files release, telling podcast host Joe Rogan
  in an interview published Wednesday that the White House botched its handling after
  raising expectations about what the documents would contain.
nut_graf: The admission, made during a lengthy interview on "The Joe Rogan Experience,"
  came as Vance acknowledged missteps in the months-long controversy over the release
  of records related to the convicted sex offender, which has drawn bipartisan criticism
  and fueled mistrust in the administration's transparency efforts.
primary_entities:
- JD Vance
- Joe Rogan
- Pam Bondi
...
generation_timestamp: '2026-07-15T19:40:00-07:00'
source_cluster_id: cluster_guardian_2026-07-15_us-news-2026-jul-15-jd-vance-joe-rogan-e
gdelt_event_ids: []
...
- slug: 2026-05-29-bondi-refuses-to-answer-questions-on-trump-s-epstein-files-role-in-closed-door-h
  headline: Bondi refuses to answer questions on Trump's Epstein files role in closed-door
    House interview
...
- slug: 2026-04-04-how-the-epstein-files-dogged-pam-bondi-s-time-as-attorney-general
  headline: How the Epstein files dogged Pam Bondi's time as attorney general
...
**Title:** ‘We screwed up the comms’: JD Vance admits errors over Epstein files release
