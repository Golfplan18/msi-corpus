...
generation_timestamp: '2026-09-10T12:45:13-07:00'
source_cluster_id: cluster_wsj_2026-09-10_nts-accused-of-sending-millions-of-user-
gdelt_event_ids: []
...
- Anthropic accused Moonshot AI and DeepSeek of routing millions of Chinese user queries to its Claude model through intermediary "transfer stations" to clone Claude's capabilities.
- Moonshot exchanged more than 23 million queries with Claude via thousands of fake accounts between May and July 2026, according to the report.
- Sensitive user data—including location information, passwords, and surveillance footage from Chengdu CCTV cameras—was forwarded to Claude, often without users' knowledge, Anthropic alleged.
- Seven China-based labs attempted to distill Claude capabilities over the past seven months, Anthropic said.
- A Moonshot spokesperson declined to comment; DeepSeek did not respond to requests for comment.
