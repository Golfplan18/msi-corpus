---
headline: Franklin, N.C. votes to return ancient Cherokee mound to Eastern Band
publish_date: '2026-01-07'
lede: 'The city council of Franklin, North Carolina, voted unanimously Monday to return the Noquisiyi Mound to the Eastern Band of Cherokee Indians, moving the largest unexcavated earthen mound in the Southeast closer to tribal control after roughly two centuries in outside hands.


  Noquisiyi — which translates to "star place" — was the center of a Cherokee mother town centuries before the founding of the United States and remains a site of deep spiritual significance to the Cherokee people. The unanimous vote initiates a process in which the tribal council must agree to accept the transfer before title to the property officially changes hands.'
nut_graf: The decision marks a milestone in a 14-year negotiation between the tribe and the town of Franklin, and adds Noquisiyi to a cultural corridor the Eastern Band is assembling from Georgia to its reservation, the Qualla Boundary.
primary_entities:
...
generation_timestamp: '2026-05-16T19:49:23Z'
source_cluster_id: cluster_ap_2026-01-07_noquisiyi-mound-eastern-band-of-cherokee
gdelt_event_ids: []
...
figures_aggregate:
  ...
  sources: []
image:
  url: /articles/2026-01-07-franklin-n-c-votes-to-return-ancient-cherokee-mound-to-eastern-band.png
  alt: 'Illustration accompanying article: Franklin, N.C. votes to return ancient Cherokee mound to Eastern Band'
  source: ai_generated
cross_article_links: []
draft: false
---
