...
secondary_headline: Louisiana gets narrower approval under Trump administration
publish_date: '2026-07-22'
lede: H.R. 1, the sweeping federal budget law signed by President Trump last year,
  is forcing state Medicaid agencies to implement work requirements and tighter eligibility
  checks, disrupting bipartisan efforts in at least 19 states to provide Medicaid
  coverage to incarcerated people before their release. At least three states have
  paused their programs, and Louisiana received approval in April under a narrower
  set of covered services than earlier Biden-era approvals.
nut_graf: The conflict between two policy goals — reducing post-release mortality
  through health care continuity and cutting federal Medicaid spending — is testing
  how much of a bridge from incarceration to community care states can build under
  a narrower program. People who study the health impacts of incarceration say untreated
  mental health and addiction issues make newly released individuals more likely to
  die.
primary_entities:
- Cody Coughenour
- Washington
...
generation_timestamp: '2026-07-22T03:24:03-07:00'
source_cluster_id: cluster_npr_2026-07-22_nx-s1-5896456-medicaid-cuts-incarceration-states-o
gdelt_event_ids: []
...
- slug: 2026-04-25-order-reclassifies-marijuana-but-leaves-federal-convictions
  ...
  strength: 0.6381
  confidence: medium
- slug: 2026-04-29-exonerees-face-roadblocks-in-the-journey-from-prison-to-employment
  relation: related
  strength: 0.6172
  confidence: medium
- slug: 2026-07-22-nearly-1-in-4-u-s-workers-stay-in-unwanted-jobs-for-health-insurance
  ...
  strength: 0.6139
  confidence: medium
- slug: 2026-02-19-california-parole-board-doctors-warn-unreliable-drug-tests-derail-addiction-care
  relation: related
  strength: 0.6427
  confidence: medium
- slug: 2026-02-20-california-parole-board-s-drug-test-approach-undermines-addiction-treatment
  relation: related
  strength: 0.6368
  confidence: medium
- slug: 2026-01-14-california-parole-grant-rate-falls-below-25-as-hearing-opportunities-expand
  ...
  strength: 0.6403
  confidence: medium
- slug: 2026-02-01-nurses-dispute-ice-account-of-how-immigrant-suffered-skull-fractures
  relation: related
  strength: 0.626
  confidence: medium
...
draft: false
related_stories:
- slug: 2026-07-21-hhs-halts-1-billion-in-medicaid-payments-after-ai-flagged-potential-fraud
  headline: HHS halts $1 billion in Medicaid payments after AI flagged potential fraud
...
- slug: 2026-04-11-trump-administration-resets-review-clock-delaying-minnesota-nursing-home-wage-fl
  headline: Trump administration resets review clock, delaying Minnesota nursing-home
    wage floor
...
- H.R. 1, the Trump budget law known as the One Big Beautiful Bill, is forcing state Medicaid agencies to implement work requirements and tighter eligibility checks, disrupting bipartisan efforts to enroll incarcerated people in Medicaid before their release.
- At least three states — Oregon, Rhode Island, and Michigan — have paused their pre-release Medicaid programs because of the law, citing limited time, resources, and funding.
- Louisiana in April became the first state approved under President Trump, but with a narrower set of services — excluding primary care — than earlier Biden-era approvals.
- Washington state officials said individuals who received Medicaid before release have been less likely to return to jail or prison; one participant said receiving his Medicaid card and appointments before release helped him enter treatment immediately.
