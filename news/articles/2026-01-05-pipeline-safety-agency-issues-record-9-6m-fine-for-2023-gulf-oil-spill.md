---
headline: Pipeline safety agency issues record $9.6M fine for 2023 Gulf oil spill
publish_date: '2026-01-05'
lede: 'Federal pipeline safety regulators on Monday issued a record $9.6 million fine against Third Coast Midstream, the Houston-based company whose 2023 pipeline failure spilled 1.1 million gallons of oil into the Gulf of Mexico off Louisiana''s coast.
...
nut_graf: 'The fine is the largest PHMSA has ever assessed, but safety advocates say it may not be large enough to change behavior: at less than 3 percent of Third Coast''s estimated annual earnings, the penalty falls below the threshold where noncompliance becomes more costly than compliance.'
primary_entities:
