---
headline: Democrats and White House delay DHS funding deal amid shutdown deadline
publish_date: '2026-01-30'
lede: Democrats and the White House reached a deal intended to avert a partial government
  shutdown, temporarily funding the Department of Homeland Security while lawmakers
  consider new limits on President Donald Trump’s surge of immigration enforcement.
  Passage was delayed late Thursday as Senate leaders sought enough support to pass
  the agreement before a midnight Friday deadline.
nut_graf: The standoff threatens another government shutdown just months after a prolonged
  closure, as Democrats press for changes to Immigration and Customs Enforcement practices
  and Republicans warn they will resist amendments to the funding package.
primary_entities:
- Chuck Schumer
- Donald Trump
- John Thune
...
generation_timestamp: '2026-05-24T06:49:59Z'
gdelt_event_ids: []
...
- slug: 2026-03-29-gop-leaders-split-as-homeland-security-funding-deal-collapses-before-shutdown-br
  headline: GOP leaders split as Homeland Security funding deal collapses before shutdown
    break
  publish_date: '2026-03-29'
  relation: related
  strength: 0.8918
- slug: 2026-04-02-gop-leaders-announce-plan-to-fully-fund-homeland-security-shutdown
  headline: GOP leaders announce plan to fully fund Homeland Security shutdown
  publish_date: '2026-04-02'
  relation: related
  strength: 0.8914
- slug: 2026-02-05-homeland-security-shutdown-more-likely-as-gop-rebuffs-democratic-demands
  headline: Homeland Security shutdown more likely as GOP rebuffs Democratic demands
...
- Democrats and the White House reached a deal to avert a partial government shutdown by temporarily funding the Department of Homeland Security while negotiations continued.
- The White House agreed to separate homeland security funding from a larger spending bill and extend Homeland Security funding for two weeks.
- Senate Majority Leader John Thune said there were “snags on both sides” as leaders tried to win support ahead of a midnight Friday deadline.
- Senate Democratic leader Chuck Schumer said Democrats are seeking reforms aimed at ending “roving patrols” and requiring tighter rules, including “masks off, body cameras on.”
- Speaker Mike Johnson said he was “vehemently opposed” to breaking up the funding package but said Congress must avoid a shutdown if the bills are separated.
